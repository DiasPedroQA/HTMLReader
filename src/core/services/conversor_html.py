...
#         def str_attr(value: str | None) -> str | None:
#             """
#             Normaliza o valor do atributo para str ou None.
#             Retorna None se o valor for None ou string vazia.

#             Args:
#                 value (str | None): Valor do atributo HTML.
#

#             Returns:
#                 str | None: Valor normalizado ou None.
#             """
...
#         links: list[LinkExtraido] = ConversorHTMLService.extrair_links(conteudo)
