...
#         conteudo: str = ler_arquivo_html(caminho=caminho_html)
#         conversor = ConversorHTMLService()
#         resultado: ResultadoConversao = conversor.converter_arquivo_html(
# caminho_arquivo=conteudo, caminho_saida=caminho_html)
#         return resultado
