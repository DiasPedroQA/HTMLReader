...
# from src.core.models.model_caminho_base import CaminhoBase
# from src.core.models.model_pasta import Pasta
...
#         return [item.nome_caminho for item in pasta.carregar_conteudo]
...
#         pasta = Pasta(caminho=caminho)
#         return [
#             Pasta(caminho=item.caminho_absoluto)
#             for item in pasta.carregar_conteudo
#             if item.retornar_o_tipo == "Pasta"
#         ]

#     def listar_arquivos(
#         self, caminho: Path, extensao_arquivo: str | None = None
#     ) -> list[Arquivo]:
#         """
...
#         Args:
#             caminho: Caminho da pasta a ser inspecionada.
#             extensao_arquivo: Extensão dos arquivos desejados (ex: '.txt').
...
#             for item in pasta_atual.carregar_conteudo
...
#             return [
#                 arquivo
#                 for arquivo in lista_arquivos_pasta_atual
#                 if arquivo.extensao_legivel == extensao_arquivo
#             ]
