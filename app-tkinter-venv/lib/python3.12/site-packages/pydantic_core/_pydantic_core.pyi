...
class ValidationError(ValueError):
    ...
    def errors(self, *, include_url: bool = True, include_context: bool = True, include_input: bool = True) -> list[ErrorDetails]:
        """
...
class PydanticCustomError(ValueError):
    ...
    def __init__(self, error_type: LiteralString, message_template: LiteralString, context: dict[str, Any] | None = None) -> None:
    ...
    def __new__(cls, error_type: LiteralString, message_template: LiteralString, context: dict[str, Any] | None = None) -> Self: ...
    @property
