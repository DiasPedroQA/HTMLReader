...
def iter_tree(root, on_error=None, follow_links=None):
    ...
    """
    warnings.warn(("util.iter_tree() is deprecated. Use util.iter_tree_files() instead."), DeprecationWarning, stacklevel=2)
...
def match_files(
    ...
    *files* (:class:`~collections.abc.Iterable` of :class:`str`) contains
    ...
    """
    warnings.warn(
        (f"{__name__}.match_files() is deprecated. Use {__name__}.match_file() with " f"a loop for better results."), DeprecationWarning, stacklevel=2
    )
...
def normalize_files(
    ...
    *separators* (:class:`~collections.abc.Collection` of :class:`str`; or
    ...
    """
    warnings.warn(
        ("util.normalize_files() is deprecated. Use util.normalize_file() " "with a loop for better results."), DeprecationWarning, stacklevel=2
    )
