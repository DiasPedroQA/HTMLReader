...
class FineGrainedBuildManager:
    ...
    def update(
        ...
        if self.previous_targets_with_errors and is_verbose(self.manager):
            self.manager.log_fine_grained("previous targets with errors: %s" % sorted(self.previous_targets_with_errors))
...
def reprocess_nodes(
    ...
    manager.errors.set_file_ignored_lines(file_node.path, file_node.ignored_lines, options.ignore_errors or state.ignore_all)
