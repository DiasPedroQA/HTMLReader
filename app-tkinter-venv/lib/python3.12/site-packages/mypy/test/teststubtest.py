...
def run_stubtest_with_stderr(stub: str, runtime: str, options: list[str], config_file: str | None = None) -> tuple[str, str]:
...
def collect_cases(fn: Callable[..., Iterator[Case]]) -> Callable[..., None]:
    ...
    def test(*args: Any, **kwargs: Any) -> None:
        ...
        for c in cases:
            ...
            assert (
                expected_error not in expected_errors
...
class StubtestMiscUnit(unittest.TestCase):
    ...
    def test_config_file_wrong_incomplete_feature(self) -> None:
        ...
        output = run_stubtest(stub=stub, runtime=runtime, options=[], config_file=config_file)
        assert output == ("warning: Warning: Unpack is already enabled by default\n" "Success: no issues found in 1 module\n")
