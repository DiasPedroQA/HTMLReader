...
class _SSLContext:
    ...
    def load_cert_chain(self, certfile: StrOrBytesPath, keyfile: StrOrBytesPath | None = None, password: _PasswordType | None = None) -> None: ...
    ...
    if sys.version_info >= (3, 13):
        ...
        def set_psk_server_callback(self, callback: Callable[[str | None], bytes] | None, identity_hint: str | None = None) -> None: ...
