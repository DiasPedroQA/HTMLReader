...
if sys.version_info >= (3, 9):
    ...
    class _AssertLogsContext(_BaseTestCaseContext, Generic[_L]):
        ...
        def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, tb: TracebackType | None) -> bool | None: ...
...
class TestCase:
    ...
    def assertLogs(self, logger: str | logging.Logger | None = None, level: int | str | None = None) -> _AssertLogsContext[_LoggingWatcher]: ...
    if sys.version_info >= (3, 10):
        def assertNoLogs(self, logger: str | logging.Logger | None = None, level: int | str | None = None) -> _AssertLogsContext[None]: ...

    @overload
    def assertAlmostEqual(self, first: _S, second: _S, places: None, msg: Any, delta: _SupportsAbsAndDunderGE) -> None: ...
    @overload
    def assertAlmostEqual(self, first: _S, second: _S, places: None = None, msg: Any = None, *, delta: _SupportsAbsAndDunderGE) -> None: ...
    @overload
    ...
    @overload
    def assertNotAlmostEqual(self, first: _S, second: _S, places: None = None, msg: Any = None, *, delta: _SupportsAbsAndDunderGE) -> None: ...
    @overload
    ...
    def assertSequenceEqual(self, seq1: Sequence[Any], seq2: Sequence[Any], msg: Any = None, seq_type: type[Sequence[Any]] | None = None) -> None: ...
...
class _AssertRaisesContext(_AssertRaisesBaseContext, Generic[_E]):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, tb: TracebackType | None) -> bool: ...
    if sys.version_info >= (3, 9):
