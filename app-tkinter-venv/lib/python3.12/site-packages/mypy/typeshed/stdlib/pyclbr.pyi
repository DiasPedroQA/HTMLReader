...
class _Object:
    ...
    if sys.version_info >= (3, 10):
        def __init__(self, module: str, name: str, file: str, lineno: int, end_lineno: int | None, parent: _Object | None) -> None: ...
    else:
...
class Class(_Object):
    ...
    if sys.version_info >= (3, 10):
        ...
        def __init__(self, module: str, name: str, super: list[Class | str] | None, file: str, lineno: int, parent: Class | None = None) -> None: ...
