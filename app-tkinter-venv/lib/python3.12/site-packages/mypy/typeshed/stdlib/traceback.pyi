...
if sys.version_info >= (3, 10):
    ...
    @overload
    def print_exception(exc: BaseException, /, *, limit: int | None = None, file: SupportsWrite[str] | None = None, chain: bool = True) -> None: ...
    @overload
...
class TracebackException:
    ...
    if sys.version_info >= (3, 11):
        ...
        @classmethod
        def from_exception(cls, exc: BaseException, *, limit: int | None = None, lookup_lines: bool = True, capture_locals: bool = False) -> Self: ...
