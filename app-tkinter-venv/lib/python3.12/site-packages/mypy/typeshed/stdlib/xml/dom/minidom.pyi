...
_ImportableNodeVar = TypeVar(
    "_ImportableNodeVar",
    bound=DocumentFragment | Attr | Element | ProcessingInstruction | CharacterData | Text | Comment | CDATASection | Entity | Notation,
)
...
def parse(file: str | SupportsRead[ReadableBuffer | str], parser: XMLReader | None = None, bufsize: int | None = None) -> Document: ...
...
class Attr(Node):
    ...
    def __init__(self, qName: str, namespaceURI: str | None = None, localName: str | None = None, prefix: str | None = None) -> None: ...
    def unlink(self) -> None: ...
    @property
    def isId(self) -> bool: ...
    @property
...
class Element(Node):
    ...
    def __init__(self, tagName: str, namespaceURI: str | None = None, prefix: str | None = None, localName: str | None = None) -> None: ...
    def unlink(self) -> None: ...
    ...
    @overload  # type: ignore[override]
    def replaceChild(self, newChild: DocumentFragment, oldChild: _ElementChildrenVar) -> _ElementChildrenVar | DocumentFragment: ...
    @overload
...
class Childless:
    ...
    def insertBefore(self, newChild: _NodesThatAreChildren | DocumentFragment, refChild: _NodesThatAreChildren | None) -> NoReturn: ...
...
class Document(Node, DocumentLS):
    ...
    @overload  # type: ignore[override]
    def replaceChild(self, newChild: DocumentFragment, oldChild: _DocumentChildrenVar) -> _DocumentChildrenVar | DocumentFragment: ...
    @overload
