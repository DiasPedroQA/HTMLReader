...
class BaseRotatingHandler(FileHandler):
    ...
    if sys.version_info >= (3, 9):
        def __init__(self, filename: StrPath, mode: str, encoding: str | None = None, delay: bool = False, errors: str | None = None) -> None: ...
    else:
...
class SysLogHandler(Handler):
    ...
    def __init__(self, address: tuple[str, int] | str = ("localhost", 514), facility: str | int = 1, socktype: SocketKind | None = None) -> None: ...
