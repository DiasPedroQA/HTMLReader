...
class zip(Iterator[_T_co]):
    if sys.version_info >= (3, 10):
        ...
        @overload
        def __new__(cls, iter1: Iterable[_T1], iter2: Iterable[_T2], iter3: Iterable[_T3], /, *, strict: bool = ...) -> zip[tuple[_T1, _T2, _T3]]: ...
        @overload
        def __new__(
...
if sys.version_info >= (3, 11):
    ...
    class BaseExceptionGroup(BaseException, Generic[_BaseExceptionT_co]):
        ...
        @overload
        def subgroup(self, condition: type[_BaseExceptionT] | tuple[type[_BaseExceptionT], ...], /) -> BaseExceptionGroup[_BaseExceptionT] | None: ...
        @overload
