...
class Misc:
    ...
    def register(self, func: Callable[..., object], subst: Callable[..., Sequence[Any]] | None = None, needcleanup: int = 1) -> str: ...
    ...
    anchor = grid_anchor
    @overload
    def grid_bbox(self, column: None = None, row: None = None, col2: None = None, row2: None = None) -> tuple[int, int, int, int] | None: ...
    @overload
...
class Canvas(Widget, XView, YView):
    ...
    def find_closest(self, x: _ScreenUnits, y: _ScreenUnits, halo: _ScreenUnits | None = None, start: str | int | None = None) -> tuple[int, ...]: ...
    ...
    @overload
    def tag_bind(self, tagOrId: str | int, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = None) -> None: ...
    @overload
    ...
    def create_polygon(
        self,
        coords: tuple[float, ...] | tuple[tuple[float, float], ...] | list[int] | list[float] | list[tuple[int, int]] | list[tuple[float, float]],
        /,
        *,
        activedash: str | int | list[int] | tuple[int, ...] = ...,
        activefill: str = ...,
    ...
    def itemconfigure(self, tagOrId: str | int, cnf: dict[str, Any] | None = None, **kw: Any) -> dict[str, tuple[str, str, str, str, str]] | None: ...
...
class Menu(Widget):
    ...
    def entryconfigure(self, index: str | int, cnf: dict[str, Any] | None = None, **kw: Any) -> dict[str, tuple[str, str, str, Any, Any]] | None: ...
...
_WhatToCount: TypeAlias = Literal["chars", "displaychars", "displayindices", "displaylines", "indices", "lines", "xpixels", "ypixels"]
...
class Image(_Image):
    name: Incomplete
    tk: _tkinter.TkappType
    def __init__(self, imgtype, name: Incomplete | None = None, cnf={}, master: Misc | _tkinter.TkappType | None = None, **kw) -> None: ...
    def __del__(self) -> None: ...
...
class PhotoImage(Image, _PhotoImageLike):
    ...
    def put(
        self,
        data: str | list[str] | list[list[str]] | list[tuple[str, ...]] | tuple[str, ...] | tuple[list[str], ...] | tuple[tuple[str, ...], ...],
    ...
    if sys.version_info >= (3, 13):
        ...
        @overload
        def data(self, format: str, *, from_coords: Iterable[int] | None = None, background: str | None = None, grayscale: bool = False) -> bytes: ...
        @overload
        def data(
            self,
            format: None = None,
