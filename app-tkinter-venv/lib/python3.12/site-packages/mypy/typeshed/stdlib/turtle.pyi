...
class ScrolledCanvas(Canvas, Frame):  # type: ignore[misc]
    ...
    hscroll: Scrollbar
    vscroll: Scrollbar
    def __init__(self, master: Misc | None, width: int = 500, height: int = 350, canvwidth: int = 600, canvheight: int = 500) -> None: ...
    canvwidth: int
    canvheight: int
...
class RawTurtle(TPen, TNavigator):  # type: ignore[misc]  # Conflicting methods in base classes
    ...
    @overload
    def shapesize(self, stretch_wid: float | None = None, stretch_len: float | None = None, outline: float | None = None) -> None: ...
    @overload
    ...
    @overload
    def shapetransform(self, t11: float | None = None, t12: float | None = None, t21: float | None = None, t22: float | None = None) -> None: ...
...
def numinput(title: str, prompt: str, default: float | None = None, minval: float | None = None, maxval: float | None = None) -> float | None: ...
...
@overload
def shapetransform(t11: float | None = None, t12: float | None = None, t21: float | None = None, t22: float | None = None) -> None: ...
