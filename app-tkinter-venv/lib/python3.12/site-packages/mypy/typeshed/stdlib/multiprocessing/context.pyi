...
class BaseContext:
    ...
    def Barrier(self, parties: int, action: Callable[..., object] | None = None, timeout: float | None = None) -> synchronize.Barrier: ...
    ...
    @overload
    def Value(self, typecode_or_type: type[_SimpleCData[_T]], *args: Any, lock: Literal[True] | _LockLike = True) -> Synchronized[_T]: ...
    @overload
    ...
    @overload
    def Array(self, typecode_or_type: str | type[_CData], size_or_initializer: int | Sequence[Any], *, lock: bool | _LockLike = True) -> Any: ...
