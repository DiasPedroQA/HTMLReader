...
class _ResultItem:
    ...
    if sys.version_info >= (3, 11):
        exit_pid: int | None
        def __init__(self, work_id: int, exception: Exception | None = None, result: Any | None = None, exit_pid: int | None = None) -> None: ...
    else:
...
class _SafeQueue(Queue[Future[Any]]):
    ...
    if sys.version_info >= (3, 12):
        ...
        def __init__(self, max_size: int | None = 0, *, ctx: BaseContext, pending_work_items: dict[int, _WorkItem[Any]]) -> None: ...
