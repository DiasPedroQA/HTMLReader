...
class TypeVar:
    ...
    if sys.version_info >= (3, 13):
        ...
        def __new__(cls, name: str, *constraints: Any, bound: Any | None = None, covariant: bool = False, contravariant: bool = False) -> Self: ...
    else:
        def __init__(self, name: str, *constraints: Any, bound: Any | None = None, covariant: bool = False, contravariant: bool = False) -> None: ...
    if sys.version_info >= (3, 10):
...
if sys.version_info >= (3, 10):
    ...
    class ParamSpec:
        ...
        if sys.version_info >= (3, 13):
            ...
            def __new__(cls, name: str, *, bound: Any | None = None, contravariant: bool = False, covariant: bool = False) -> Self: ...
        else:
...
class ForwardRef(_Final):
    ...
    if sys.version_info >= (3, 13):
        ...
        def _evaluate(self, globalns: dict[str, Any] | None, localns: Mapping[str, Any] | None, *, recursive_guard: frozenset[str]) -> Any | None: ...
        @overload
        def _evaluate(
            self,
