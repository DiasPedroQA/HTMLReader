...
class DocTestFinder:
    def __init__(self, verbose: bool = False, parser: DocTestParser = ..., recurse: bool = True, exclude_empty: bool = True) -> None: ...
    def find(
        self,
        obj: object,
        name: str | None = None,
...
class DocTestRunner:
    ...
    def run(self, test: DocTest, compileflags: int | None = None, out: _Out | None = None, clear_globs: bool = True) -> TestResults: ...
