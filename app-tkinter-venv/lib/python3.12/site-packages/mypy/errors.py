...
class Errors:
    ...
    def is_ignored_error(self, line: int, info: ErrorInfo, ignores: dict[int, list[str]]) -> bool:
        ...
        if info.code and self.is_error_code_enabled(info.code):
            return info.code.code in ignores[line] or info.code.sub_code_of is not None and info.code.sub_code_of.code in ignores[line]
        return False
    ...
    def generate_unused_ignore_errors(self, file: str) -> None:
        if is_typeshed_file(self.options.abs_custom_typeshed_dir if self.options else None, file) or file in self.ignored_files:
            return
