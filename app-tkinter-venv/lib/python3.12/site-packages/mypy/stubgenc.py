...
class InspectionStubGenerator(BaseStubGenerator):
        ...
        if self.resort_members:
            ...
            for i, line in enumerate(output):
                if (
                    ...
                    and (not self._output[-1].startswith("class") or (len(output) > i + 1 and output[i + 1].startswith("    ")))
    ...
    def generate_class_stub(self, class_name: str, cls: type, output: list[str], parent_class: ClassInfo | None = None) -> None:
