...
class ExtensionManager:
    ...
    def __init__(
        ...
        self._init_attributes(namespace, propagate_map_exceptions=propagate_map_exceptions, on_load_failure_callback=on_load_failure_callback)
        extensions = self._load_plugins(invoke_on_load, invoke_args, invoke_kwds, verify_requirements)
        self._init_plugins(extensions)

    @classmethod
    def make_test_instance(
        cls, extensions, namespace="TESTING", propagate_map_exceptions=False, on_load_failure_callback=None, verify_requirements=False
    ):
        ...
        o = cls.__new__(cls)
        o._init_attributes(namespace, propagate_map_exceptions=propagate_map_exceptions, on_load_failure_callback=on_load_failure_callback)
        ...
        for ep in self.list_entry_points():
            ...
            try:
                ...
                if self._on_load_failure_callback is not None:
                    ...
                    # traceback.
                    LOG.error("Could not load %r: %s", ep.name, err, exc_info=LOG.isEnabledFor(logging.DEBUG))
        return extensions
