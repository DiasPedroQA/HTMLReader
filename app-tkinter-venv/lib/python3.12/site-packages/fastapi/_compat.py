...
if PYDANTIC_V2:
    ...
    from pydantic._internal._schema_generation_shared import GetJsonSchemaHandler as GetJsonSchemaHandler  # type: ignore[attr-defined]
    ...
    try:
        ...
        from pydantic_core.core_schema import general_plain_validator_function as with_info_plain_validator_function  # noqa: F401
    ...
    from pydantic.schema import get_annotation_from_field_info as get_annotation_from_field_info  # type: ignore[no-redef]  # noqa: F401
    from pydantic.schema import (
