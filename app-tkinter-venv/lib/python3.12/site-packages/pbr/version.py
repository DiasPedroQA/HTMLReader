...
class SemanticVersion(object):
    ...
    def _sort_key(self):
        ...
        if self._dev_count and not self._prerelease_type:
            ...
            uq_dev = 1
        return (self._major, self._minor, self._patch, uq_dev, rc_lookup[self._prerelease_type], self._prerelease, self._dev_count or sys.maxsize)
    ...
    def _long_version(self, pre_separator, rc_marker=""):
        ...
        if self._prerelease_type:
            segments.append("%s%s%s%s" % (pre_separator, rc_marker, self._prerelease_type, self._prerelease))
        if self._dev_count:
