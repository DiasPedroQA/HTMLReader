    ...
    scenarios = [
        ...
        (
            "with_markers",
            {
                ...
                """,
                "expected_extra_requires": {"test:(python_version=='2.6')": ["foo", "baz<1.6"], "test": ["bar", "zaz"]},
            },
        ),
        (
            "no_extras",
...
class TestDataFilesParsing(base.BaseTestCase):
    ...
    scenarios = [
        (
            ...
            """,
                "data_files": [("i like spaces/", ["dir with space/file with spc 2", "dir with space/file with spc 1"])],
            },
        )
    ]
