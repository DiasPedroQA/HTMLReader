...
class Return(ControlOp):
    ...
    def __init__(self, value: Value, line: int = -1, *, yield_target: BasicBlock | None = None) -> None:
        super().__init__(line)
        self.value = value
...
class TupleSet(RegisterOp):
    ...
    def __init__(self, items: list[Value], line: int) -> None:
        ...
        self.tuple_type = RTuple([arg.type if not is_short_int_rprimitive(arg.type) else int_rprimitive for arg in items])
