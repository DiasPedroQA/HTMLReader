...
class ExtClassBuilder(ClassBuilder):
    ...
    def finalize(self, ir: ClassIR) -> None:
        attrs_with_defaults, default_assignments = find_attr_initializers(self.builder, self.cdef, self.skip_attr_default)
...
class AttrsClassBuilder(DataClassBuilder):
    ...
    def get_type_annotation(self, stmt: AssignmentStmt) -> TypeInfo | None:
        if isinstance(stmt.rvalue, CallExpr):
            ...
            if isinstance(callee, MemberExpr) and callee.fullname in ["attr.ib", "attr.attr"] and "type" in stmt.rvalue.arg_names:
        ...
        for stmt in info.defn.defs.body:
            if (
                ...
                if isinstance(stmt.rvalue, RefExpr) and stmt.rvalue.fullname == "builtins.None":
                    if not is_optional_type(attr_type) and not is_object_rprimitive(attr_type) and not is_none_rprimitive(attr_type):
                        continue
