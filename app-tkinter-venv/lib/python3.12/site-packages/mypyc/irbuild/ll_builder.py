...
class LowLevelIRBuilder:
    ...
    def translate_special_method_call(
        ...
        primitive_op = self.matching_primitive_op(primitive_ops_candidates, [base_reg] + args, line, result_type, can_borrow=can_borrow)
        return primitive_op
    ...
    def translate_eq_cmp(self, lreg: Value, rreg: Value, expr_op: str, line: int) -> Value | None:
        ...
        cmp_varies_at_runtime = (
            not class_ir.is_method_final("__eq__") or not class_ir.is_method_final("__ne__") or class_ir.inherits_python or class_ir.is_augmented
        )
