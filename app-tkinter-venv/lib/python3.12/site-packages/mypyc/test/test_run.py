...
class TestRun(MypycDataSuite):
    ...
    def run_case_step(self, testcase: DataDrivenTestCase, incremental_step: int) -> None:
        ...
        try:
            ...
            ir, cfiles, _ = emitmodule.compile_modules_to_c(result, compiler_options=compiler_options, errors=errors, groups=groups)
        ...
        if debugger:
            ...
            assert False, "Test can't pass in debugging mode. " "(Make sure to pass -s to pytest to interact with the debugger)"
