...
def message_about_scripts_not_on_PATH(scripts: Sequence[str]) -> Optional[str]:
    ...
    warn_for: Dict[str, Set[str]] = {
        parent_dir: scripts for parent_dir, scripts in grouped_by_dir.items() if os.path.normcase(os.path.normpath(parent_dir)) not in not_warn_dirs
    }
    if not warn_for:
        return None
    ...
    def data_scheme_file_maker(zip_file: ZipFile, scheme: Scheme) -> Callable[[RecordPath], "File"]:
        ...
        def make_data_scheme_file(record_path: RecordPath) -> "File":
            ...
            try:
                ...
                message = (
                    f"Unexpected file in {wheel_path}: {record_path!r}. .data directory" " contents should be named like: '<scheme key>/<path>'."
                )
