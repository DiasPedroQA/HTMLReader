...
class MissingPyProjectBuildRequires(DiagnosticPipError):
    ...
    def __init__(self, *, package: str) -> None:
        super().__init__(
            ...
            context=Text("This package has an invalid pyproject.toml file.\n" "The [build-system] table is missing the mandatory `requires` key."),
...
class ResolutionTooDeepError(DiagnosticPipError):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            context=("Pip cannot resolve the current dependencies as the dependency graph " "is too complex for pip to solve efficiently."),
            hint_stmt=("Try adding lower bounds to constrain your dependencies, " "for example: 'package>=2.0.0' instead of just 'package'. "),
