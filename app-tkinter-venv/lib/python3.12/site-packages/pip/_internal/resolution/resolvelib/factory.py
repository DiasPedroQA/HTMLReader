...
class Factory:
    ...
    def find_candidates(
        ...
        return (
            ...
            if id(c) not in incompat_ids and constraint.is_satisfied_by(c) and all(is_satisfied_by(req, c) for req in requirements[identifier])
        )
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        ...
        if running_under_virtualenv() and dist.in_site_packages:
            message = f"Will not install to the user site because it will lack " f"sys.path precedence to {dist.raw_name} in {dist.location}"
