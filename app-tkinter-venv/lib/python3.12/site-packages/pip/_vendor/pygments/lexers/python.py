...
from pip._vendor.pygments.lexer import DelegatingLexer, RegexLexer, bygroups, combined, default, include, this, using, words
from pip._vendor.pygments.token import Comment, Error, Generic, Keyword, Name, Number, Operator, Other, Punctuation, String, Text, Whitespace
...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        "dqf": [(r'"', String.Double, "#pop"), (r'\\\\|\\"|\\\n', String.Escape), include("fstrings-double")],  # included here for raw strings
        "sqf": [(r"'", String.Single, "#pop"), (r"\\\\|\\'|\\\n", String.Escape), include("fstrings-single")],  # included here for raw strings
        "dqs": [(r'"', String.Double, "#pop"), (r'\\\\|\\"|\\\n', String.Escape), include("strings-double")],  # included here for raw strings
        "sqs": [(r"'", String.Single, "#pop"), (r"\\\\|\\'|\\\n", String.Escape), include("strings-single")],  # included here for raw strings
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"!=|==|<<|>>|[-~+/*%=<>&^|.?]", Operator),
            (r"(from)(\d+)(<=)(\s+)(<)(\d+)(:)", bygroups(Keyword, Number.Integer, Operator, Whitespace, Operator, Name, Punctuation)),
            include("keywords"),
...
class NumPyLexer(PythonLexer):
    ...
    def analyse_text(text):
        ltext = text[:1000]
        return (shebang_matches(text, r"pythonw?(3(\.\d)?)?") or "import " in ltext) and ("import numpy" in ltext or "from numpy import" in ltext)
