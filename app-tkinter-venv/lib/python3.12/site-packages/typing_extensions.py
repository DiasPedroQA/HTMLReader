...
if _PEP_728_IMPLEMENTED:
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, *, total=True, closed=None, extra_items=NoExtraItems):
            ...
            if _TAKES_MODULE:
                own_checked_annotations = {n: typing._type_check(tp, msg, module=tp_dict.__module__) for n, tp in own_annotations.items()}
            else:
        ...
        *type_params* is a tuple of type parameters that are in scope when
        ...
        if isinstance(value, ForwardRef):
            ...
            return evaluate_forward_ref(
                value, globals=globals, locals=locals, type_params=type_params, owner=owner, _recursive_guard=_recursive_guard, format=format
            )
