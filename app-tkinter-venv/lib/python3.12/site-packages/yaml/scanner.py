    ...
    def scan_block_scalar_indicators(self, start_mark):
        ...
        if ch in "+-":
            ...
            if ch in "0123456789":
                ...
                if increment == 0:
                    raise ScannerError(
                        "while scanning a block scalar", start_mark, "expected indentation indicator in the range 1-9, but found 0", self.get_mark()
                    )
                self.forward()
        ...
        if ch not in "\0 \r\n\x85\u2028\u2029":
            raise ScannerError(
                "while scanning a block scalar", start_mark, "expected chomping or indentation indicators, but found %r" % ch, self.get_mark()
            )
