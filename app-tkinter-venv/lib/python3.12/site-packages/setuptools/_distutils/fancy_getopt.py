            ...
            if long[-1] == "=":  # option takes an argument?
                ...
                if alias_to is not None:
                    if self.takes_arg[alias_to]:
                        raise DistutilsGetoptError(f"invalid negative alias '{long}': " f"aliased option '{alias_to}' takes a value")
            ...
            if alias_to is not None:
                if self.takes_arg[long] != self.takes_arg[alias_to]:
                    raise DistutilsGetoptError(
                        f"invalid alias '{long}': inconsistent with " f"aliased option '{alias_to}' (one of them takes a value, " "the other doesn't"
                    )
