...
class PlatformInfo:
    ...
    def current_dir(self, hidex86=False, x64=False) -> str:
        ...
        """
        return "" if (self.current_cpu == "x86" and hidex86) else r"\x64" if (self.current_cpu == "amd64" and x64) else rf"\{self.current_cpu}"
    ...
    def target_dir(self, hidex86=False, x64=False) -> str:
        ...
        """
        return "" if (self.target_cpu == "x86" and hidex86) else r"\x64" if (self.target_cpu == "amd64" and x64) else rf"\{self.target_cpu}"
...
class EnvironmentInfo:
    ...
    def VCRuntimeRedist(self) -> str | None:
        ...
        # vcruntime path
        candidate_paths = (os.path.join(prefix, arch_subdir, crt_dir, vcruntime) for (prefix, crt_dir) in itertools.product(prefixes, crt_dirs))
