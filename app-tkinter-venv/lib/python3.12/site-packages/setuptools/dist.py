...
def check_requirements(dist, attr: str, value: _OrderedStrSequence) -> None:
    ...
    try:
        ...
        msg = f"{attr!r} must be a string or iterable of strings " f"containing valid project/version requirement specifiers; {error}"
...
class Distribution(_Distribution):
    ...
    def _enforce_underscore(self, opt: str, section: str) -> str:
        ...
        SetuptoolsDeprecationWarning.emit(
            f"Invalid dash-separated key {opt!r} in {section!r} (setup.cfg), " f"please use the underscore name {underscore_opt!r} instead.",
            f"""
