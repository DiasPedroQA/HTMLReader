...
class GenerateSchema:
    ...
    def _path_schema(self, tp: Any, path_type: Any) -> CoreSchema:
        ...
        strict_inner_schema = core_schema.bytes_schema(strict=True) if (path_type is bytes) else core_schema.str_schema(strict=True)
        ...
        with (
            ...
            with self._config_wrapper_stack.push(config):
                ...
                for field_name, annotation in annotations.items():
                    ...
                    required = (field_name in required_keys or "required" in field_info._qualifiers) and "not_required" not in field_info._qualifiers
    ...
    def _arguments_schema(
        ...
        for i, (name, p) in enumerate(sig.parameters.items()):
            ...
            if parameter_mode is not None:
                arg_schema = self._generate_parameter_schema(name, annotation, AnnotationSource.FUNCTION, p.default, parameter_mode)
    ...
    def _arguments_v3_schema(
        ...
        for i, (name, p) in enumerate(sig.parameters.items()):
            ...
            parameters_list.append(self._generate_parameter_v3_schema(name, annotation, AnnotationSource.FUNCTION, parameter_mode, default=p.default))
...
def _extract_get_pydantic_json_schema(tp: Any) -> GetJsonSchemaFunction | None:
    ...
    if hasattr(tp, "__modify_schema__"):
        ...
        has_custom_v2_modify_js_func = js_modify_function is not None and BaseModel.__get_pydantic_json_schema__.__func__ not in (  # type: ignore
            js_modify_function,
