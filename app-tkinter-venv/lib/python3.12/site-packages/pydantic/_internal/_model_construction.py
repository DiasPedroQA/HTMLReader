            ...
            if __pydantic_generic_metadata__:
                ...
                if parameters and parent_parameters and not all(x in parameters for x in parent_parameters):
                    ...
                    if RootModelRootType in parent_parameters and RootModelRootType not in parameters:
                        ...
                        error_message = f"All parameters must be present on typing.Generic;" f" you should inherit from {generic_type_label}."
    ...
    for var_name, value in list(namespace.items()):
        if var_name == "model_config" or var_name == "__pydantic_extra__":
            ...
            if var_name.startswith("__"):
                raise NameError("Private attributes must not use dunder names;" f" use a single underscore prefix instead of {var_name!r}.")
            elif is_valid_field_name(var_name):
                raise NameError(
                    "Private attributes must not use valid field names;" f' use sunder names, e.g. {"_" + var_name!r} instead of {var_name!r}.'
                )
            ...
            raise NameError(f"Fields must not use names with leading underscores;" f" e.g., use {suggested_name!r} instead of {var_name!r}.")
