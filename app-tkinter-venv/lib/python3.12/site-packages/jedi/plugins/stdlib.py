...
from jedi.inference.arguments import AbstractArguments, ParamIssue, TreeArgumentsWrapper, iterate_argument_clinic, repack_with_argument_clinic
from jedi.inference.base_value import NO_VALUES, ContextualizedNode, LazyValueWrapper, ValueSet, ValueWrapper
from jedi.inference.filters import AttributeOverwrite, DictFilter, ParserTreeFilter, publish_method
...
def builtins_classmethod(functions, value, arguments):
    return ValueSet(
        ClassMethodObject(class_method_object, function) for class_method_object in value.py__call__(arguments=arguments) for function in functions
    )
