...
from jedi.inference.base_value import NO_VALUES, ContextualizedNode, TreeValue, ValueSet, ValueWrapper
...
class BaseFunctionExecutionContext(ValueContext, TreeContextMixin):
    ...
    def get_yield_lazy_values(self, is_async=False):
        ...
        for yield_, for_stmt in for_parents:
            ...
            if for_stmt.type == "for_stmt" and parent == self.tree_node and parser_utils.for_stmt_defines_one_name(for_stmt):  # Simplicity for now.
