...
from jedi.inference.base_value import NO_VALUES, Value, ValueSet, ValueWrapper, iterator_to_value_set
...
class TreeInstance(_BaseTreeInstance):
    ...
    def _get_annotated_class_object(self):
        from jedi.inference.gradual.annotation import infer_type_vars_for_execution, py__annotations__
