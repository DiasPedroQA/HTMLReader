...
from jedi.inference.names import AbstractNameDefinition, AnonymousParamName, NameWrapper, ParamName, TreeNameDefinition
    ...
    def __init__(self, parent_context, node_context=None):
        ...
        if path is None:
            ...
            self._parso_cache_node = get_parso_cache_node(
                module_context.inference_state.latest_grammar if module_context.is_stub() else module_context.inference_state.grammar, path
            )
