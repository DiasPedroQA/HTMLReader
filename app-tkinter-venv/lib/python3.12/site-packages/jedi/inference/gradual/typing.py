...
from jedi.inference.base_value import NO_VALUES, LazyValueWrapper, Value, ValueSet, ValueWrapper
...
class ProxyTypingValue(BaseTypingValue):
    ...
    def with_generics(self, generics_tuple):
        return self.index_class.create_cached(
            self.inference_state, self.parent_context, self._tree_name, generics_manager=TupleGenericManager(generics_tuple)
        )
