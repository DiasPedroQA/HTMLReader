...
from jedi.inference.gradual.typeshed import create_stub_module, import_module_decorator, parse_stub_module
...
def load_module_from_path(inference_state, file_io, import_names=None, is_package=None):
    ...
    if is_stub:
        ...
        return create_stub_module(
            inference_state, inference_state.latest_grammar, values, parse_stub_module(inference_state, file_io), file_io, import_names
        )
    else:
        module = _load_python_module(
            inference_state,
