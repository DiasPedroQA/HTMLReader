...
class OutputWrapper(TextIOBase):
    ...
    ending: str = ...
    def __init__(self, out: Union[StringIO, TextIOWrapper], style_func: Optional[Callable[[str], str]] = ..., ending: str = ...) -> None: ...
    def __getattr__(self, name: str) -> Callable: ...
    def isatty(self) -> bool: ...
    def write(self, msg: str, style_func: Optional[Callable[[str], str]] = ..., ending: Optional[str] = ...) -> None: ...  # type: ignore[override]
