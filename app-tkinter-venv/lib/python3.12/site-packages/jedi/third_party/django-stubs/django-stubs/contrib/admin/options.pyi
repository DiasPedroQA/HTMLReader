...
from typing import Any, Callable, Dict, Iterator, List, Mapping, Optional, Sequence, Set, Tuple, Type, TypeVar, Union
...
class BaseModelAdmin:
    ...
    def formfield_for_choice_field(self, db_field: Field, request: Optional[HttpRequest], **kwargs: Any) -> TypedChoiceField: ...
    def get_field_queryset(self, db: None, db_field: RelatedField, request: Optional[HttpRequest]) -> Optional[QuerySet]: ...
    ...
    def get_fieldsets(self, request: HttpRequest, obj: Optional[Model] = ...) -> List[Tuple[Optional[str], Dict[str, Any]]]: ...
...
class ModelAdmin(BaseModelAdmin):
    ...
    def get_action_choices(self, request: HttpRequest, default_choices: List[Tuple[str, str]] = ...) -> List[Tuple[str, str]]: ...
    ...
    def response_add(self, request: HttpRequest, obj: Model, post_url_continue: Optional[str] = ...) -> HttpResponse: ...
    ...
    def get_deleted_objects(self, objs: QuerySet, request: HttpRequest) -> Tuple[List[Any], Dict[Any, Any], Set[Any], List[Any]]: ...
