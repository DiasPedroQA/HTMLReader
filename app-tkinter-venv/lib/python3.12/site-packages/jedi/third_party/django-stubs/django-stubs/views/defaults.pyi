...
def page_not_found(request: HttpRequest, exception: Optional[Exception], template_name: str = ...) -> HttpResponseNotFound: ...
...
def permission_denied(request: HttpRequest, exception: Exception, template_name: str = ...) -> HttpResponseForbidden: ...
