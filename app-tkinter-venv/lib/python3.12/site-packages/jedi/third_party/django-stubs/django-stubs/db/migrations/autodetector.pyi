...
class MigrationAutodetector:
    ...
    def __init__(self, from_state: ProjectState, to_state: ProjectState, questioner: Optional[MigrationQuestioner] = ...) -> None: ...
    def changes(
        self,
    ...
    def only_relation_agnostic_fields(self, fields: List[Tuple[str, Field]]) -> List[Tuple[str, List[Any], Dict[str, Union[Callable, int, str]]]]: ...
