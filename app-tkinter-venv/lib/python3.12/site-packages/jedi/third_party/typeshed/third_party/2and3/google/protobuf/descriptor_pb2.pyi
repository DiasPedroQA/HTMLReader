...
class FileDescriptorProto(google___protobuf___message___Message):
    ...
    def HasField(
        ...
        field_name: typing_extensions___Literal[
            "name", b"name", "options", b"options", "package", b"package", "source_code_info", b"source_code_info", "syntax", b"syntax"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class DescriptorProto(google___protobuf___message___Message):
    ...
    class ExtensionRange(google___protobuf___message___Message):
        ...
        def HasField(self, field_name: typing_extensions___Literal["end", b"end", "options", b"options", "start", b"start"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal["end", b"end", "options", b"options", "start", b"start"]) -> None: ...
    ...
    class ReservedRange(google___protobuf___message___Message):
        ...
        def HasField(self, field_name: typing_extensions___Literal["end", b"end", "start", b"start"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal["end", b"end", "start", b"start"]) -> None: ...
    ...
    def extension_range(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___DescriptorProto.ExtensionRange]: ...
    @property
    ...
    def HasField(self, field_name: typing_extensions___Literal["name", b"name", "options", b"options"]) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "enum_type",
...
class ExtensionRangeOptions(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal["uninterpreted_option", b"uninterpreted_option"]) -> None: ...
...
class OneofDescriptorProto(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal["name", b"name", "options", b"options"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal["name", b"name", "options", b"options"]) -> None: ...
...
class EnumDescriptorProto(google___protobuf___message___Message):
    ...
    def reserved_range(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___EnumDescriptorProto.EnumReservedRange]: ...
    def __init__(
        self,
        *,
        name: typing___Optional[typing___Text] = None,
    ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "name", b"name", "options", b"options", "reserved_name", b"reserved_name", "reserved_range", b"reserved_range", "value", b"value"
        ],
    ) -> None: ...
...
class EnumValueDescriptorProto(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal["name", b"name", "number", b"number", "options", b"options"]) -> builtin___bool: ...
...
class ServiceDescriptorProto(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal["name", b"name", "options", b"options"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal["method", b"method", "name", b"name", "options", b"options"]) -> None: ...
...
class FieldOptions(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal[
            "ctype", b"ctype", "deprecated", b"deprecated", "jstype", b"jstype", "lazy", b"lazy", "packed", b"packed", "weak", b"weak"
        ],
    ) -> builtin___bool: ...
    def ClearField(
        self,
...
class EnumOptions(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal["allow_alias", b"allow_alias", "deprecated", b"deprecated"]) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
...
class EnumValueOptions(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal["deprecated", b"deprecated"]) -> builtin___bool: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["deprecated", b"deprecated", "uninterpreted_option", b"uninterpreted_option"]
    ) -> None: ...
...
class MethodOptions(google___protobuf___message___Message):
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["deprecated", b"deprecated", "idempotency_level", b"idempotency_level"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "deprecated", b"deprecated", "idempotency_level", b"idempotency_level", "uninterpreted_option", b"uninterpreted_option"
        ],
    ) -> None: ...
...
class UninterpretedOption(google___protobuf___message___Message):
    ...
    class NamePart(google___protobuf___message___Message):
        ...
        def HasField(self, field_name: typing_extensions___Literal["is_extension", b"is_extension", "name_part", b"name_part"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal["is_extension", b"is_extension", "name_part", b"name_part"]) -> None: ...
...
class SourceCodeInfo(google___protobuf___message___Message):
    ...
    class Location(google___protobuf___message___Message):
        ...
        def HasField(
            self, field_name: typing_extensions___Literal["leading_comments", b"leading_comments", "trailing_comments", b"trailing_comments"]
        ) -> builtin___bool: ...
        def ClearField(
            self,
            field_name: typing_extensions___Literal[
    ...
    def ClearField(self, field_name: typing_extensions___Literal["location", b"location"]) -> None: ...
...
class GeneratedCodeInfo(google___protobuf___message___Message):
    ...
    class Annotation(google___protobuf___message___Message):
        ...
        def HasField(
            self, field_name: typing_extensions___Literal["begin", b"begin", "end", b"end", "source_file", b"source_file"]
        ) -> builtin___bool: ...
        def ClearField(
            self, field_name: typing_extensions___Literal["begin", b"begin", "end", b"end", "path", b"path", "source_file", b"source_file"]
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal["annotation", b"annotation"]) -> None: ...
