...
class Version(google___protobuf___message___Message):
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["major", b"major", "minor", b"minor", "patch", b"patch", "suffix", b"suffix"]
    ) -> builtin___bool: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["major", b"major", "minor", b"minor", "patch", b"patch", "suffix", b"suffix"]
    ) -> None: ...
...
class CodeGeneratorRequest(google___protobuf___message___Message):
    ...
    def proto_file(
        self,
    ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[google___protobuf___descriptor_pb2___FileDescriptorProto]: ...
    @property
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["compiler_version", b"compiler_version", "parameter", b"parameter"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "compiler_version", b"compiler_version", "file_to_generate", b"file_to_generate", "parameter", b"parameter", "proto_file", b"proto_file"
        ],
    ) -> None: ...
...
class CodeGeneratorResponse(google___protobuf___message___Message):
    ...
    class File(google___protobuf___message___Message):
        ...
        def HasField(
            self,
            field_name: typing_extensions___Literal[
                "content", b"content", "generated_code_info", b"generated_code_info", "insertion_point", b"insertion_point", "name", b"name"
            ],
        ) -> builtin___bool: ...
        def ClearField(
            self,
    ...
    def HasField(self, field_name: typing_extensions___Literal["error", b"error", "supported_features", b"supported_features"]) -> builtin___bool: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["error", b"error", "file", b"file", "supported_features", b"supported_features"]
    ) -> None: ...
