...
class Transport(Thread, ClosingContextManager):
    ...
    def open_session(self, window_size: Optional[int] = ..., max_packet_size: Optional[int] = ..., timeout: Optional[float] = ...) -> Channel: ...
    ...
    def request_port_forward(self, address: str, port: int, handler: Optional[Callable[[Channel, _Addr, _Addr], None]] = ...) -> int: ...
    ...
    def auth_interactive_dumb(self, username: str, handler: Optional[_InteractiveCallback] = ..., submethods: str = ...) -> List[str]: ...
