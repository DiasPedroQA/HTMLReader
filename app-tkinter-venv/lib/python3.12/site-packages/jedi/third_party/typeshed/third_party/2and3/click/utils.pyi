...
class LazyFile(object):
    ...
    errors: str
    atomic: bool
    def __init__(self, filename: str, mode: str = ..., encoding: Optional[str] = ..., errors: str = ..., atomic: bool = ...) -> None: ...
...
def echo(message: object = ..., file: Optional[IO[Text]] = ..., nl: bool = ..., err: bool = ..., color: Optional[bool] = ...) -> None: ...
