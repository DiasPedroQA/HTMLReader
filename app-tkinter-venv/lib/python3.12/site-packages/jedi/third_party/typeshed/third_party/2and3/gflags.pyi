...
def register_validator(flag_name: str, checker: Callable[[Any], bool], message: str = ..., flag_values: FlagValues = ...) -> None: ...
...
class EnumFlag(Flag):
    def __init__(self, name: str, default: Optional[str], help: str, enum_values: List[str], short_name: str, **args: Any) -> None: ...

def DEFINE_enum(name: str, default: Optional[str], enum_values: Iterable[str], help: str, flag_values: FlagValues = ..., **args: Any) -> None: ...
...
def DEFINE_multi_string(name: str, default: Optional[Union[str, List[str]]], help: str, flag_values: FlagValues = ..., **args: Any) -> None: ...
