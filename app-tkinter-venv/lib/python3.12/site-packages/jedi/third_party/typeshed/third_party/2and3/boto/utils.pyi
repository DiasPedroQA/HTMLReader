...
def merge_meta(headers: Mapping[str, str], metadata: Mapping[str, str], provider: Optional[_Provider] = ...) -> Mapping[str, str]: ...
...
def fetch_file(uri: str, file: Optional[IO[str]] = ..., username: Optional[str] = ..., password: Optional[str] = ...) -> Optional[IO[str]]: ...
...
class ShellCommand:
    ...
    wait: bool
    fail_fast: bool
    def __init__(self, command: subprocess._CMD, wait: bool = ..., fail_fast: bool = ..., cwd: Optional[subprocess._TXT] = ...) -> None: ...
...
class AuthSMTPHandler(logging.handlers.SMTPHandler):
    username: str
    password: str
    def __init__(self, mailhost: str, username: str, password: str, fromaddr: str, toaddrs: Sequence[str], subject: str) -> None: ...
...
def write_mime_multipart(content: List[Tuple[str, str]], compress: bool = ..., deftype: str = ..., delimiter: str = ...) -> str: ...
...
def compute_hash(fp: IO[Any], buf_size: int = ..., size: Optional[int] = ..., hash_algorithm: Any = ...) -> Tuple[str, str, int]: ...
...
class RequestHook:
    def handle_request_data(self, request: boto.connection.HTTPRequest, response: boto.connection.HTTPResponse, error: bool = ...) -> Any: ...
