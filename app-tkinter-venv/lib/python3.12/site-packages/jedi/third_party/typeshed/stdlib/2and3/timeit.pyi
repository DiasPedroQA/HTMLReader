...
class Timer:
    if sys.version_info >= (3, 5):
        def __init__(self, stmt: _stmt = ..., setup: _stmt = ..., timer: _Timer = ..., globals: Optional[Dict[str, Any]] = ...) -> None: ...
    else:
...
if sys.version_info >= (3, 5):
    def timeit(stmt: _stmt = ..., setup: _stmt = ..., timer: _Timer = ..., number: int = ..., globals: Optional[Dict[str, Any]] = ...) -> float: ...
    def repeat(
        stmt: _stmt = ...,
        setup: _stmt = ...,
        timer: _Timer = ...,
