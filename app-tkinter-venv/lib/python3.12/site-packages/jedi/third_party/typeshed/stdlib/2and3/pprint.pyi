...
if sys.version_info >= (3, 8):
    ...
    def pprint(object: object, stream: Optional[IO[str]] = ..., indent: int = ..., width: int = ..., depth: Optional[int] = ...) -> None: ...
...
class PrettyPrinter:
    if sys.version_info >= (3, 8):
        ...
        def __init__(self, indent: int = ..., width: int = ..., depth: Optional[int] = ..., stream: Optional[IO[str]] = ...) -> None: ...
