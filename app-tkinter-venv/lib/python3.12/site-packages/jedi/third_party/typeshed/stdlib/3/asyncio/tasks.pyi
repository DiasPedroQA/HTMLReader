...
def as_completed(fs: Iterable[_FutureT[_T]], *, loop: Optional[AbstractEventLoop] = ..., timeout: Optional[float] = ...) -> Iterator[Future[_T]]: ...
...
def gather(
    ...
    *,
    loop: Optional[AbstractEventLoop] = ...,
    return_exceptions: bool = ...,
) -> Future[Tuple[Union[_T1, BaseException], Union[_T2, BaseException], Union[_T3, BaseException], Union[_T4, BaseException]]]: ...
@overload
def gather(
    coro_or_future1: _FutureT[_T1],
    coro_or_future2: _FutureT[_T2],
