...
if sys.version_info >= (3, 8):
    ...
    class Distribution:
        ...
        @overload
        @classmethod
        def discover(cls, *, context: None = ..., name: Optional[str] = ..., path: List[str] = ..., **kwargs: Any) -> Iterable[Distribution]: ...
        @staticmethod
    ...
    @overload
    def distributions(*, context: None = ..., name: Optional[str] = ..., path: List[str] = ..., **kwargs: Any) -> Iterable[Distribution]: ...
