...
class SysLogHandler(Handler):
    ...
    def __init__(self, address: Union[Tuple[str, int], str] = ..., facility: int = ..., socktype: Optional[SocketKind] = ...) -> None: ...
...
class HTTPHandler(Handler):
    if sys.version_info >= (3, 5):
        ...
        def __init__(self, host: str, url: str, method: str = ..., secure: bool = ..., credentials: Optional[Tuple[str, str]] = ...) -> None: ...
    else:
...
if sys.version_info >= (3,):
    ...
    class QueueListener:
        if sys.version_info >= (3, 7):
            def __init__(self, queue: Union[SimpleQueue[Any], Queue[Any]], *handlers: Handler, respect_handler_level: bool = ...) -> None: ...
