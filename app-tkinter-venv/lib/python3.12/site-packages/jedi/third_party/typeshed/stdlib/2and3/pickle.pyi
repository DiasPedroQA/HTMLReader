...
if sys.version_info >= (3, 8):
    ...
    def dumps(obj: Any, protocol: Optional[int] = ..., *, fix_imports: bool = ..., buffer_callback: _BufferCallback = ...) -> bytes: ...
    def load(
        file: IO[bytes],
        *,
        fix_imports: bool = ...,
    ...
    def loads(__data: bytes, *, fix_imports: bool = ..., encoding: str = ..., errors: str = ..., buffers: Optional[Iterable[Any]] = ...) -> Any: ...
