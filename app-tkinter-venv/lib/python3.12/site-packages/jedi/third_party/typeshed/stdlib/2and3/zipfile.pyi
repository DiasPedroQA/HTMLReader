...
class ZipExtFile(io.BufferedIOBase):
    ...
    name: str
    if sys.version_info >= (3, 7):
        def __init__(self, fileobj: IO[bytes], mode: str, zipinfo: ZipInfo, pwd: Optional[bytes] = ..., close_fileobj: bool = ...) -> None: ...
    else:
        def __init__(
            self,
            fileobj: IO[bytes],
...
class ZipFile:
    ...
    if sys.version_info >= (3, 8):
        ...
        def __init__(self, file: Union[StrPath, IO[bytes]], mode: Text = ..., compression: int = ..., allowZip64: bool = ...) -> None: ...
    ...
    def extractall(self, path: Optional[StrPath] = ..., members: Optional[Iterable[Text]] = ..., pwd: Optional[bytes] = ...) -> None: ...
    if sys.version_info >= (3,):
