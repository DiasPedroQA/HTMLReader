...
class socket:
    ...
    if sys.platform == "linux" and sys.version_info >= (3, 6):
        def sendmsg_afalg(self, msg: Iterable[bytes] = ..., *, op: int, iv: Any = ..., assoclen: int = ..., flags: int = ...) -> int: ...
    if sys.version_info >= (3,):
...
if sys.version_info >= (3, 9):
    if sys.platform != "win32":
        ...
        def send_fds(sock: socket, buffers: Iterable[bytes], fds: Union[bytes, Iterable[int]], flags: int = ..., address: None = ...) -> int: ...
