...
class Text(Widget, XView, YView):
    ...
    def replace(self, index1: _TextIndex, index2: _TextIndex, chars: str, *args: Union[_TextIndex, str, _TkinterSequence[str]]) -> None: ...
...
class Image:
    name: Any
    tk: _tkinter.TkappType
    def __init__(self, imgtype, name: Optional[Any] = ..., cnf=..., master: Optional[Union[Misc, _tkinter.TkappType]] = ..., **kw): ...
    def __del__(self): ...
