...
class BaseEventLoop(AbstractEventLoop, metaclass=ABCMeta):
    ...
    if sys.version_info >= (3, 7):
        ...
        def call_later(self, delay: float, callback: Callable[..., Any], *args: Any, context: Optional[Context] = ...) -> TimerHandle: ...
        def call_at(self, when: float, callback: Callable[..., Any], *args: Any, context: Optional[Context] = ...) -> TimerHandle: ...
    else:
