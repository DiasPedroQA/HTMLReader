...
class int:
    ...
    @classmethod
    def from_bytes(cls, bytes: Union[Iterable[int], SupportsBytes], byteorder: str, *, signed: bool = ...) -> int: ...  # TODO buffer object argument
...
class bytes(ByteString):
    ...
    def startswith(self, prefix: Union[bytes, Tuple[bytes, ...]], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def startswith(self, __prefix: Union[bytes, Tuple[bytes, ...]], __start: Optional[int] = ..., __end: Optional[int] = ...) -> bool: ...
...
def eval(__source: Union[str, bytes, CodeType], __globals: Optional[Dict[str, Any]] = ..., __locals: Optional[Mapping[str, Any]] = ...) -> Any: ...
def exec(
...
@overload
def map(__func: Callable[[_T1, _T2, _T3], _S], __iter1: Iterable[_T1], __iter2: Iterable[_T2], __iter3: Iterable[_T3]) -> Iterator[_S]: ...
@overload
def map(
...
@overload
def zip(__iter1: Iterable[_T1], __iter2: Iterable[_T2], __iter3: Iterable[_T3], __iter4: Iterable[_T4]) -> Iterator[Tuple[_T1, _T2, _T3, _T4]]: ...
@overload
def zip(
