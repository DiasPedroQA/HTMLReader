...
MESSAGE_UNINSTALLABLE = "The generated requirements file may be rejected by pip install. " "See # WARNING lines for details."
...
class OutputWriter:
    ...
    def write_header(self) -> Iterator[str]:
        if self.emit_header:
            yield comment("#")
            yield comment("# This file is autogenerated by pip-compile with Python " f"{sys.version_info.major}.{sys.version_info.minor}")
    ...
    def _format_requirement(
        ...
        if hasattr(ireq, "_source_ireqs"):
            required_by |= {_comes_from_as_string(src_ireq.comes_from) for src_ireq in ireq._source_ireqs if src_ireq.comes_from}
