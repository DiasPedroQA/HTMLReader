...
"""
    ...
    def test_correctly_nested_tables(self):
        ...
        self.assert_soup(
            "<table><thead><tr><td>Foo</td></tr></thead>" "<tbody><tr><td>Bar</td></tr></tbody>" "<tfoot><tr><td>Baz</td></tr></tfoot></table>"
        )
...
"""
    ...
    def test_meta_tag_reflects_current_encoding(self):
        ...
        shift_jis_html = (
            "<html><head>\n%s\n" '<meta http-equiv="Content-language" content="ja"/>' "</head><body>Shift-JIS markup goes here."
        ) % meta_tag
