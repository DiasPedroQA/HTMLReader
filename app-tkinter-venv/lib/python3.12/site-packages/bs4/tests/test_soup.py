...
class TestConstructor(SoupTest):
    ...
    def test_invalid_markup_type(self, bad_markup):
        ...
        assert f"Incoming markup is of an invalid type: {bad_markup!r}. Markup must be a string, a bytestring, or an open filehandle." in str(
            exc_info.value
        )
...
class TestWarnings(SoupTest):
    ...
    def _assert_warning(self, warnings: Iterable[warnings.WarningMessage], cls: Type[Warning]) -> warnings.WarningMessage:
        for w in warnings:
