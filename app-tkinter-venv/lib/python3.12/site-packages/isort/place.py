...
def _src_path(
    ...
    for src_path in src_paths:
        ...
        if nested_module and (
            ...
            or (config.auto_identify_namespace_packages and _is_namespace_package(module_path, config.supported_extensions))
        ):
...
def _is_module(path: Path) -> bool:
    return (
        ...
        or any(exists_case_sensitive(str(path.with_suffix(ext_suffix))) for ext_suffix in importlib.machinery.EXTENSION_SUFFIXES)
