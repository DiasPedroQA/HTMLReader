        ...
        while from_imports:
            ...
            if "*" in from_imports and config.combine_star:
                ...
                while from_imports and (
                    from_imports[0] not in as_imports or (config.combine_as_imports and parsed.imports[section]["from"][module][from_import])
                ):
    ...
    for module in straight_modules:
        ...
        if module in parsed.as_map["straight"]:
            ...
            import_definition.extend(
                (f"{import_type} {module} as {as_import}", f"{module} as {as_import}") for as_import in parsed.as_map["straight"][module]
            )
        else:
            import_definition.append((f"{import_type} {module}", module))
