...
class SuperWeirdWordPlugin(MessDetectorPlugin):
    ...
    def feed(self, character: str) -> None:
        if character.isalpha():
            ...
            if is_cjk(character) or is_hangul(character) or is_katakana(character) or is_hiragana(character) or is_thai(character):
        ...
        if (character.isspace() or is_punctuation(character) or is_separator(character)) and self._buffer:
            ...
            if buffer_length >= 4:
                ...
                elif is_accentuated(self._buffer[-1]) and self._buffer[-1].isupper() and all(_.isupper() for _ in self._buffer) is False:
