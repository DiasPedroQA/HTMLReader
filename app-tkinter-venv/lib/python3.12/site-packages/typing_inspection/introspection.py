...
def _unpack_annotated_inner(annotation: Any, unpack_type_aliases: Literal["lenient", "eager"], check_annotated: bool) -> tuple[Any, list[Any]]:
    origin = get_origin(annotation)
    if check_annotated and typing_objects.is_annotated(origin):
        ...
        annotated_type, sub_meta = _unpack_annotated_inner(annotated_type, unpack_type_aliases=unpack_type_aliases, check_annotated=False)
...
def _unpack_annotated(annotation: Any, /, *, unpack_type_aliases: Literal["skip", "lenient", "eager"] = "eager") -> tuple[Any, list[Any]]:
    if unpack_type_aliases == "skip":
