...
from pygments.token import Comment, Error, Keyword, Literal, Name, Number, Operator, Punctuation, String, Text, Whitespace
...
class RacketLexer(RegexLexer):
    ...
    tokens = {
        ...
        "quoted-datum": [include("datum"), (_opening_parenthesis, Punctuation, ("#pop", "quoted-list")), include("datum*")],
        "quoted-list": [include("list"), (r"(?!\Z)", Text, "quoted-datum")],
        "block-comment": [(r"#\|", Comment.Multiline, "#push"), (r"\|#", Comment.Multiline, "#pop"), (r"[^#|]+|.", Comment.Multiline)],
        "string": [
            (r'"', String.Double, "#pop"),
