...
class ThriftLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            ...
            (
                words(
                    ("void", "bool", "byte", "i16", "i32", "i64", "double", "string", "binary", "map", "list", "set", "slist", "senum"), suffix=r"\b"
                ),
                Keyword.Type,
            ),
            (
...
class ZeekLexer(RegexLexer):
    ...
    tokens = {
        ...
        "types": [
            ...
            (r"(type)(\s+)((?:[A-Za-z_]\w*)(?:::(?:[A-Za-z_]\w*))*)(\s*)(:)", bygroups(Keyword, Whitespace, Name, Whitespace, Operator)),
            (
        ...
        "keywords": [
            ...
            (r"(module)(\s+)(([A-Za-z_]\w*)(?:::([A-Za-z_]\w*))*)\b", bygroups(Keyword.Namespace, Whitespace, Name.Namespace)),
        ],
        "literals": [
            (r'"', String, "string"),
...
class RslLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(^[ \t]*)([\w]+)([ \t]*)(\([\w\s,]*\))([ \t]*)(is|as)", bygroups(Whitespace, Name.Function, Whitespace, Text, Whitespace, Keyword)),
...
class SnowballLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "root1": [
            ...
            (words(("strings", "booleans", "integers", "routines", "externals", "groupings"), suffix=r"\b"), Keyword.Reserved, "declaration"),
            (
                words(
                    (
                        "do",
