...
class SpiceLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (words(("const", "signed", "unsigned", "inline", "public", "heap", "compose"), suffix=r"\b"), Keyword.Pseudo),
            ...
            (words(("printf", "sizeof", "alignof", "len", "panic"), suffix=r"\b(\()"), bygroups(Name.Builtin, Punctuation)),
            # numeric literals
