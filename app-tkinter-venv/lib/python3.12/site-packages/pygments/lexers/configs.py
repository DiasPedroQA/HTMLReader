...
from pygments.token import Comment, Error, Generic, Keyword, Literal, Name, Number, Operator, Punctuation, String, Text, Whitespace
...
class IniLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"""(.*?)([ \t]*)([=:])([ \t]*)(["'])""", bygroups(Name.Attribute, Whitespace, Operator, Whitespace, String), "quoted_value"),
            (
                r"(.*?)([ \t]*)([=:])([ \t]*)([^;#\n]*)(\\)(\s+)",
...
class RegeditLexer(RegexLexer):
    ...
    tokens = {
        ...
        "value": [
            ...
            (r"(dword|hex(?:\([0-9a-fA-F]\))?)(:)([0-9a-fA-F,]+)", bygroups(Name.Variable, Punctuation, Number), "#pop"),
...
class Cfengine3Lexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(body|bundle)(\s+)(\S+)(\s+)(\w+)(\()", bygroups(Keyword, Whitespace, Keyword, Whitespace, Name.Function, Punctuation), "arglist"),
            (r"(body|bundle)(\s+)(\S+)(\s+)(\w+)", bygroups(Keyword, Whitespace, Keyword, Whitespace, Name.Function)),
            (
                r'(")([^"]+)(")(\s+)(string|slist|int|real)(\s*)(=>)(\s*)',
                bygroups(Punctuation, Name.Variable, Punctuation, Whitespace, Keyword.Type, Whitespace, Operator, Whitespace),
            ),
...
class DockerLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"#.*", Comment),
            (r"(FROM)([ \t]*)(\S*)([ \t]*)(?:(AS)([ \t]*)(\S*))?", bygroups(Keyword, Whitespace, String, Whitespace, Keyword, Whitespace, String)),
            ...
            (rf"(VOLUME|ENTRYPOINT|CMD|SHELL)(\s+)({_lb})(\[.*?\])", bygroups(Keyword, Whitespace, using(BashLexer), using(JsonLexer))),
...
class TerraformLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "basic": [
            ...
            # e.g. terraform {
            # e.g. egress {
            (r"(\s*)([0-9a-zA-Z-_]+)(\s*)(=?)(\s*)(\{)", bygroups(Whitespace, Name.Builtin, Whitespace, Operator, Whitespace, Punctuation)),
            # Assignment with attributes, e.g. something = ...
            (r"(\s*)([0-9a-zA-Z-_]+)(\s*)(=)(\s*)", bygroups(Whitespace, Name.Attribute, Whitespace, Operator, Whitespace)),
            # Assignment with environment variables and similar, e.g. "something" = ...
            # or key value assignment, e.g. "SlotName" : ...
            (r'(\s*)("\S+")(\s*)([=:])(\s*)', bygroups(Whitespace, Literal.String.Double, Whitespace, Operator, Whitespace)),
