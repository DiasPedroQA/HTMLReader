...
class HLSLShaderLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    ("bool", "double", "float", "int", "half", "min16float", "min10float", "min16int", "min12int", "min16uint", "uint"),
                    prefix=r"\b",
...
class PostScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"[0-9]+\#(\-|\+)?([0-9]+\.?|[0-9]*\.[0-9]+|[0-9]+\.[0-9]*)" r"((e|E)[0-9]+)?" + delimiter_end, Number.Oct),
...
class GnuplotLexer(RegexLexer):
    ...
    tokens = {
        ...
        "plot": [
            (
                _shortened_many(
                    "ax$es", "axi$s", "bin$ary", "ev$ery", "i$ndex", "mat$rix", "s$mooth", "thru$", "t$itle", "not$itle", "u$sing", "w$ith"
                ),
                Name.Builtin,
            ),
            include("genericargs"),
