...
class RustLexer(RegexLexer):
    ...
    tokens = {
        ...
        "base": [
            ...
            (
                words(
                    ("abstract", "become", "do", "final", "macro", "override", "priv", "typeof", "try", "unsized", "virtual", "yield"), suffix=r"\b"
                ),
                Keyword.Reserved,
            ),
            ...
            # Decimal literals
            (r"[0-9][0-9_]*(\.[0-9_]+[eE][+\-]?[0-9_]+|" r"\.[0-9_]*(?!\.)|[eE][+\-]?[0-9_]+)", Number.Float, "number_lit"),
