...
def _create_tag_line_pattern(inner_pattern, ignore_case=False):
    return (
        (r"(?i)" if ignore_case else r"") + r"^(##)( *)" + inner_pattern + r"( *)(:)( *)(.*?)( *)$"  # groups 1, 2  # group 3
    )  # groups 4, 5, 6, 7, 8
    ...
    tokens = {
        "root": [
            ...
            _create_tag_line_token(
                r"((?:[nN][oO][tT][eE][sS]|[tT][iI][tT][lL][eE])-(?:ptBR|zhCN|" r"enCN|frFR|deDE|itIT|esMX|ptPT|koKR|ruRU|esES|zhTW|enTW|enGB|enUS))",
                Name.Builtin,
            ),
            # other official tags
            _create_tag_line_token(
