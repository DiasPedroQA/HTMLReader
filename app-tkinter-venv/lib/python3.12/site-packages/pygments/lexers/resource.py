...
class ResourceLexer(RegexLexer):
    ...
    tokens = {
        ...
        "string": [
            (r"(\\x[0-9a-f]{2}|\\u[0-9a-f]{4}|\\U00[0-9a-f]{6}|" r'\\[0-7]{1,3}|\\c.|\\[abtnvfre\'"?\\]|\\\{|[^"{\\])+', String),
        ...
        "message": [
            ...
            (r"(,)(\s*)([a-z]+)(\s*)(,)(\s*)", bygroups(Operator, String.Escape, Keyword, String.Escape, Operator, String.Escape), "choice"),
            (r"\s+", String.Escape),
        ],
        "choice": [
