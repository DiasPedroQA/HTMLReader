...
from pygments.lexer import Lexer, RegexLexer, bygroups, combined, default, do_insertions, include, inherit, line_re, this, using, words
from pygments.token import Comment, Generic, Keyword, Name, Number, Operator, Other, Punctuation, String, Text, Whitespace
...
class JavascriptLexer(RegexLexer):
    ...
    tokens = {
        "commentsandwhitespace": [(r"\s+", Whitespace), (r"<!--", Comment), (r"//.*?$", Comment.Single), (r"/\*.*?\*/", Comment.Multiline)],
        "slashstartsregex": [
...
class TypeScriptLexer(JavascriptLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\b(module)(\s*)([\w?.$]+)(\s*)", bygroups(Keyword.Reserved, Whitespace, Name.Other, Whitespace), "slashstartsregex"),
            # Match stuff like: (function: return type)
            (r"([\w?.$]+)(\s*)(:)(\s*)([\w?.$]+)", bygroups(Name.Other, Whitespace, Operator, Whitespace, Keyword.Type)),
...
class KalLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"\b(safe(?=\s))?(\s*)(wait(?=\s))(\s+)(for)\b", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword), "waitfor"),
            ...
            (
                words(
                    ("true", "false", "yes", "no", "on", "off", "null", "nothing", "none", "NaN", "Infinity", "undefined"),
                    prefix=r"(?<![.$])",
                    suffix=r"\b",
                ),
                Keyword.Constant,
        ...
        "sqs": [(r"'", String, "#pop"), (r'#|\\.|"', String), include("strings")],  # single quoted strings don't need " escapses
        "tdqs": [
            (r'"""', String, "#pop"),
        ...
        "tsqs": [(r"'''", String, "#pop"), (r'#|\\.|\'|"', String), include("strings")],  # no need to escape quotes in triple-strings
    }
...
class LiveScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"([$a-zA-Z_][\w.\-:$]*)(\s*)([:=])(\s+)", bygroups(Name.Variable, Whitespace, Operator, Whitespace), "slashstartsregex"),
            (r"(@[$a-zA-Z_][\w.\-:$]*)(\s*)([:=])(\s+)", bygroups(Name.Variable.Instance, Whitespace, Operator, Whitespace), "slashstartsregex"),
...
class DartLexer(RegexLexer):
    ...
    tokens = {
        ...
        "string_double": [(r'"', String.Double, "#pop"), (r'[^"$\\\n]+', String.Double), include("string_common"), (r"\$+", String.Double)],
        ...
        "string_single": [(r"'", String.Single, "#pop"), (r"[^'$\\\n]+", String.Single), include("string_common"), (r"\$+", String.Single)],
...
class LassoLexer(RegexLexer):
    ...
    tokens = {
        ...
        "lasso": [
            ...
            (r"(self)(\s*)(->)(\s*)('[a-z_][\w.]*')", bygroups(Name.Builtin.Pseudo, Whitespace, Operator, Whitespace, Name.Variable.Class)),
        ...
        "commamember": [
            (r"(([a-z_][\w.]*=?|[-+*/%])" r"(?=\s*(\(([^()]*\([^()]*\))*[^)]*\)\s*)?(::[\w.\s]+)?=>))", Name.Function, "signature"),
            include("whitespacecomments"),
            default("#pop"),
        ],
    }
...
class ObjectiveJLexer(RegexLexer):
    ...
    tokens = {
        ...
        "statements": [
            ...
            (
                r"(int|long|float|short|double|char|unsigned|signed|void|" r"id|BOOL|bool|boolean|IBOutlet|IBAction|SEL|@outlet|@action)\b",
                Keyword.Type,
            ),
        ...
        "classname": [
            ...
            (r"([a-zA-Z_]\w*)(" + _ws + r":" + _ws + r")([a-zA-Z_]\w*)?", bygroups(Name.Class, using(this), Name.Class), "#pop"),
            # interface definition for a category
            (r"([a-zA-Z_]\w*)(" + _ws + r"\()([a-zA-Z_]\w*)(\))", bygroups(Name.Class, using(this), Name.Label, Text), "#pop"),
...
class EarlGreyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            include("errors"),
            (
                words(("with", "where", "when", "and", "not", "or", "in", "as", "of", "is"), prefix=r"(?<=\s|\[)", suffix=r"(?![\w$\-])"),
                Operator.Word,
            ),
            (r"[*@]?->", Name.Function),
            (r"[+\-*/~^<>%&|?!@#.]*=", Operator.Word),
        ...
        "assignment": [(r"(\.)?([a-zA-Z$_](?:[\w$\-]*[\w$])?)" r"(?=\s+[+\-*/~^<>%&|?!@#.]*\=\s)", bygroups(Punctuation, Name.Variable))],
        "errors": [
            (words(("Error", "TypeError", "ReferenceError"), prefix=r"(?<![\w\-$.])", suffix=r"(?![\w\-$.])"), Name.Exception),
            (
                r"""(?x)
                (?<![\w$])
                E\.[\w$](?:[\w$\-]*[\w$])?
        ...
        "builtins": [
            ...
            (words(("true", "false", "null", "undefined"), prefix=r"(?<![\w\-$.])", suffix=r"(?![\w\-$.])"), Name.Constant),
        ],
        "name": [
        ...
        "sqs": [(r"'", String, "#pop"), (r"\\\\|\\'|\\\n", String.Escape), (r"\{", String.Interpol, "interpoling_string"), include("strings")],
        "tdqs": [
            (r'"""', String, "#pop"),
            include("strings"),
        ],
...
class JuttleLexer(RegexLexer):
    ...
    tokens = {
        "commentsandwhitespace": [(r"\s+", Whitespace), (r"(//.*?)(\n)", bygroups(Comment.Single, Whitespace)), (r"/\*.*?\*/", Comment.Multiline)],
        "slashstartsregex": [
            include("commentsandwhitespace"),
            (r"/(\\.|[^[/\\\n]|\[(\\.|[^\]\\\n])*])+/" r"([gimuysd]+\b|\B)", String.Regex, "#pop"),
            (r"(?=/)", Text, ("#pop", "badregex")),
        ...
        "root": [
            ...
            (
                r"(batch|emit|filter|head|join|keep|pace|pass|put|read|reduce|remove|" r"sequence|skip|sort|split|tail|unbatch|uniq|view|write)\b",
                Keyword.Reserved,
            ),
