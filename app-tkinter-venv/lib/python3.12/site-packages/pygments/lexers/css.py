...
class CssLexer(RegexLexer):
    ...
    tokens = {
        ...
        "content": [
            ...
            (r"(" + r"|".join(_css_properties) + r")(\s*)(\:)", bygroups(Keyword, Whitespace, Punctuation), "value-start"),
        ...
        "value-start": [
            ...
            include("urls"),
            (r"(" + r"|".join(_functional_notation_keyword_values) + r")(\()", bygroups(Name.Builtin, Punctuation), "function-start"),
