...
class WebIDLLexer(RegexLexer):
    ...
    tokens = {
        ...
        "const_value": [
            include("common"),
            (words(("true", "false", "-Infinity", "Infinity", "NaN", "null"), suffix=_keyword_suffix), Keyword.Constant, "#pop"),
            (r"-?(?:(?:[0-9]+\.[0-9]*|[0-9]*\.[0-9]+)(?:[Ee][+-]?[0-9]+)?" + r"|[0-9]+[Ee][+-]?[0-9]+)", Number.Float, "#pop"),
        ...
        "interface_body": [
            (words(("iterable", "maplike", "setlike"), suffix=_keyword_suffix), Keyword, "iterable_maplike_setlike_rest"),
            (
                words(
                    ("setter", "getter", "creator", "deleter", "legacycaller", "inherit", "static", "stringifier", "jsonifier"),
