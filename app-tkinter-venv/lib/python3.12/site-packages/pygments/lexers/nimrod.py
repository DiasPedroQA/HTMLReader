...
class NimrodLexer(RegexLexer):
    ...
    tokens = {
        ...
        "chars": [(r'\\([\\abcefnrtvl"\']|x[a-f0-9]{2}|[0-9]{1,3})', String.Escape), (r"'", String.Char, "#pop"), (r".", String.Char)],
        "strings": [
        ...
        "dqs": [(r'\\([\\abcefnrtvl"\']|\n|x[a-f0-9]{2}|[0-9]{1,3})', String.Escape), (r'"', String, "#pop"), include("strings")],
        "rdqs": [(r'"(?!")', String, "#pop"), (r'""', String.Escape), include("strings")],
        "tdqs": [(r'"""', String.Double, "#pop"), include("strings"), (r"\n", String.Double)],
        "funcname": [(r"((?![\d_])\w)(((?!_)\w)|(_(?!_)\w))*", Name.Function, "#pop"), (r"`.+`", Name.Function, "#pop")],
        "nl": [(r"\n", String)],
        "float-number": [(r"\.(?!\.)[0-9_]*[f]*", Number.Float), (r"e[+-]?[0-9][0-9_]*", Number.Float), default("#pop")],
