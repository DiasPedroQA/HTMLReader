...
class Inform6Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "value": [
            ...
            (rf"([{_squote}])(@\{{[0-9a-fA-F]*\}})([{_squote}])", bygroups(String.Char, String.Escape, String.Char), "#pop"),
            ...
            (
                words(
                    ("child", "children", "elder", "eldest", "glk", "indirect", "metaclass", "parent", "random", "sibling", "younger", "youngest"),
                    suffix=r"\b",
                ),
                Name.Builtin,
                "#pop",
        ...
        "string": [
            ...
            (rf"@(\\\s*[{_newline}]\s*)*[({{]((\\\s*[{_newline}]\s*)*[0-9a-zA-Z_])*" rf"(\\\s*[{_newline}]\s*)*[)}}]", String.Escape),
        ...
        "constant*": [include("_whitespace"), (r",", Punctuation), (r"=", Punctuation, "value?"), (_name, Name.Constant, "value?"), default("#pop")],
        ...
        # Class, Object, Nearby
        "class-name": [include("_whitespace"), (r"(?=[,;]|(class|has|private|with)\b)", Text, "#pop"), (_name, Name.Class, "#pop")],
        "duplicates": [include("_whitespace"), (r"\(", Punctuation, ("#pop", "expression", "_expression")), default("#pop")],
        "_object-head": [(rf"[{_dash}]>", Punctuation), (r"(class|has|private|with)\b", Keyword.Declaration, "#pop"), include("_global")],
        "object-body": [
            include("_whitespace"),
            (r";", Punctuation, "#pop:2"),
            (r",", Punctuation),
        ...
        "class-segment": [include("_whitespace"), (r"(?=[,;]|(class|has|private|with)\b)", Text, "#pop"), (_name, Name.Class), default("value")],
        # Extend, Verb
        "grammar": [
            include("_whitespace"),
        ...
        "before-plain-string?": [include("_whitespace"), (rf"[{_dquote}]", String.Double, ("#pop", "plain-string")), default("#pop")],
        ...
        "property-keyword*": [
            include("_whitespace"),
            (words(("additive", "individual", "long"), suffix=rf"\b(?=(\s*|(![^{_newline}]*[{_newline}]))*[_a-zA-Z])"), Keyword),
            default("#pop"),
        ],
        "trace-keyword?": [
            include("_whitespace"),
            (
                words(
                    ("assembly", "dictionary", "expressions", "lines", "linker", "objects", "off", "on", "symbols", "tokens", "verbs"), suffix=r"\b"
                ),
                Keyword,
                "#pop",
            ),
        ...
        "miscellaneous-keyword?": [
            ...
            (r"(a|A|an|address|char|name|number|object|property|string|the|" rf"The)\b(?=(\s+|(![^{_newline}]*))*\))", Keyword.Pseudo, "#pop"),
            (rf"{_name}(?=(\s+|(![^{_newline}]*))*\))", Name.Function, "#pop"),
            default("#pop"),
        ],
        "(?": [include("_whitespace"), (r"\(", Punctuation, "#pop"), default("#pop")],
        "for": [include("_whitespace"), (r";", Punctuation, ("_for-expression", "_expression")), default(("_for-expression", "_expression"))],
        "print-list": [
            include("_whitespace"),
            (r";", Punctuation, "#pop"),
            (r":", Error),
...
class Inform7Lexer(RegexLexer):
    ...
    for level in token_variants:
        tokens[level] = {
            ...
            "+i6t-root": [(rf"[^{Inform6Lexer._newline}]*", Comment.Preproc, ("directive", "+p"))],  # For Inform6TemplateLexer
            "root": [
                (r"(\|?\s)+", Text),
            ...
            "+phrase-definition": [
                ...
                (
                    rf"(\([{_dash}])(.*?)([{_dash}]\))",
                    bygroups(Punctuation, using(this, state=("+i6-root", "directive", "default", "statements"), i6t="+i6t-inline"), Punctuation),
                    "#pop",
                ),
                default("#pop"),
            ],
            "+use-option": [
                ...
                (
                    rf"(\([{_dash}])(.*?)([{_dash}]\))",
                    bygroups(Punctuation, using(this, state=("+i6-root", "directive"), i6t="+i6t-use-option"), Punctuation),
                    "#pop",
                ),
                default("#pop"),
            ],
            "+comment": [(r"[^\[\]]+", Comment.Multiline), (r"\[", Comment.Multiline, "#push"), (r"\]", Comment.Multiline, "#pop")],
            "+text": [(rf"[^\[{_dquote}]+", String.Double), (r"\[.*?\]", String.Interpol), (rf"[{_dquote}]", String.Double, "#pop")],
            "+heading?": [
                (r"(\|?\s)+", Text),
                (r"\[", Comment.Multiline, "+comment"),
            ...
            "+i6t": [
                ...
                (rf"(\{{[{_dash}])(lines)(:)([^}}]*)(\}}?)", bygroups(Punctuation, Keyword, Punctuation, Text, Punctuation), "+lines"),
                (rf"(\{{[{_dash}])([^:}}]*)(:?)([^}}]*)(\}}?)", bygroups(Punctuation, Keyword, Punctuation, Text, Punctuation)),
...
class Tads3Lexer(RegexLexer):
    ...
    def _make_string_state(triple, double, verbatim=None, _escape=_escape):
        ...
        if verbatim:
            ...
            state.append((rf"\\?<(/|\\\\|(?!{_escape})\\){verbatim}(?=[\s=>])", Name.Tag, ("#pop", f"{prefix}qs", tag_state_name)))
        else:
            state += [
    ...
    tokens = {
        ...
        "object-body/no-braces": [(r";", Punctuation, "#pop"), (r"\{", Punctuation, ("#pop", "object-body")), include("object-body")],
        "object-body": [
            (r";", Punctuation),
            (r"\{", Punctuation, "#push"),
            (r"\}", Punctuation, "#pop"),
            ...
            (rf"({_name})({_ws}*)(\{{)", bygroups(Name.Function, using(this, state="whitespace"), Punctuation), "block"),
            (
                rf"({_name})({_ws}*)(:)",
        ...
        "main/object-body": [
            include("main/basic"),
            (rf"({_name})({_ws}*)(=?)", bygroups(Name.Variable, using(this, state="whitespace"), Punctuation), ("#pop", "more", "main")),
            default("#pop:2"),
        ],
        "block?/root": [
            (r"\{", Punctuation, ("#pop", "block")),
            include("whitespace"),
            (r'(?=[\[\'"<(:])', Text, ("#pop", "object-body/no-braces", "grammar", "grammar-rules")),  # It might be a VerbRule macro.
        ...
        "block/embed": [(r">>", String.Interpol, "#pop"), include("block/basic"), (r"(?!\Z)", Text, ("more/embed", "main"))],
        "main/basic": [
            include("whitespace"),
            ...
            # Two-token keywords
            (rf"(extern)({_ws}+)(object\b)", bygroups(Keyword.Reserved, using(this, state="whitespace"), Keyword.Reserved)),
            (
            ...
            (rf"(object)({_ws}+)(template\b)", bygroups(Keyword.Reserved, using(this, state="whitespace"), Keyword.Reserved), ("#pop", "template")),
            (rf"(string)({_ws}+)(template\b)", bygroups(Keyword, using(this, state="whitespace"), Keyword.Reserved), ("#pop", "function-name")),
            # Keywords
        ...
        "more/inner": [(r"\}", Punctuation, "#pop"), (r",", Punctuation, "main/inner"), (r"(in|step)\b", Keyword, "main/inner"), include("more")],
        # Local
        ...
        "main/parameters": [
            ...
            (rf"({_name})({_ws}+)({_name})", bygroups(Name.Class, using(this, state="whitespace"), Name.Variable), "#pop"),
            (r"\[+", Punctuation),
            include("main/basic"),
        ...
        "inherited": [(r"<", Punctuation, ("#pop", "classes", "class")), include("whitespace"), (_name, Name.Class, "#pop"), default("#pop")],
        "operator": [(r"negate\b", Operator.Word, "#pop"), include("whitespace"), (_operator, Operator), default("#pop")],
        "propertyset": [
        ...
        "classes": [(r"[:,]", Punctuation, "class"), include("whitespace"), (r">", Punctuation, "#pop"), default("#pop")],
        "constants": [
            (r",+", Punctuation),
            (r";", Punctuation, "#pop"),
        ...
        "variables": [(r",+", Punctuation), (r"\)", Punctuation, "#pop"), include("whitespace"), (_name, Name.Variable)],
        ...
        # Strings
        "string": [(r'"""', String.Double, "tdqs"), (r"'''", String.Single, "tsqs"), (r'"', String.Double, "dqs"), (r"'", String.Single, "sqs")],
        ...
        "s/verbatim": [
            ...
            (
                rf"<<(%(_({_escape}|\\?.)|[\-+ ,#]|\[\d*\]?)*\d*\.?\d*({_escape}|\\?.)|" r"\s*((else|otherwise)\s+)?(if|unless)\b)?",
                String.Interpol,
        ...
        # Regular expressions
        "tdqr": [(r'[^\\"]+', String.Regex), (r'\\"*', String.Regex), (r'"{3,}', String.Regex, "#pop"), (r'"', String.Regex)],
        "tsqr": [(r"[^\\']+", String.Regex), (r"\\'*", String.Regex), (r"'{3,}", String.Regex, "#pop"), (r"'", String.Regex)],
