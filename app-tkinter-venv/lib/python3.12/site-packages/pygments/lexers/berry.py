...
class BerryLexer(RegexLexer):
    ...
    tokens = {
        ...
        "controls": [
            (
                words(("if", "elif", "else", "for", "while", "do", "end", "break", "continue", "return", "try", "except", "raise"), suffix=r"\b"),
                Keyword,
            )
        ],
        "builtins": [
        ...
        "numbers": [(r"0[xX][a-fA-F0-9]+", Number.Hex), (r"-?\d+", Number.Integer), (r"(-?\d+\.?|\.\d)\d*([eE][+-]?\d+)?", Number.Float)],
        "name": [(_name, Name)],
