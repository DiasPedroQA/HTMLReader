...
class CrystalLexer(ExtendedRegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(0x[0-9A-Fa-f]+(?:_[0-9A-Fa-f]+)*(?:_?[iu][0-9]+)?)\b(\s*)([/?])?", bygroups(Number.Hex, Whitespace, Operator)),
            ...
            (r"(0\b|[1-9][\d]*(?:_\d+)*(?:_?[iu][0-9]+)?)\b(\s*)([/?])?", bygroups(Number.Integer, Whitespace, Operator)),
            # Names
