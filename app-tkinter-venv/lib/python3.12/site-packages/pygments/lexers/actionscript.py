...
class ActionScript3Lexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"\s+", Whitespace),
            (r"(function\s+)(" + identifier + r")(\s*)(\()", bygroups(Keyword.Declaration, Name.Function, Text, Operator), "funcparams"),
            (
            ...
            (r"(import|package)(\s+)((?:" + identifier + r"|\.)+)(\s*)", bygroups(Keyword, Whitespace, Name.Namespace, Whitespace)),
            (r"(new)(\s+)(" + typeidentifier + r")(\s*)(\()", bygroups(Keyword, Whitespace, Keyword.Type, Whitespace, Operator)),
            (r"//.*?\n", Comment.Single),
            (r"/\*.*?\*/", Comment.Multiline),
            (r"/(\\\\|\\[^\\]|[^\\\n])*/[gisx]*", String.Regex),
        ...
        "type": [
            (r"(\s*)(:)(\s*)(" + typeidentifier + r"|\*)", bygroups(Whitespace, Operator, Whitespace, Keyword.Type), "#pop:2"),
            (r"\s+", Text, "#pop:2"),
            default("#pop:2"),
        ],
        "defval": [
