...
class BareLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"(type)(\s+)([A-Z][a-zA-Z0-9]+)(\s+)(\{)", bygroups(Keyword, Whitespace, Name.Class, Whitespace, Text), "struct"),
            (r"(type)(\s+)([A-Z][a-zA-Z0-9]+)(\s+)(\()", bygroups(Keyword, Whitespace, Name.Class, Whitespace, Text), "union"),
