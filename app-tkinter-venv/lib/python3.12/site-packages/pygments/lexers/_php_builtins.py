...
MODULES = {
    ...
    "Aliases and deprecated Mysqli": ("mysqli_connect", "mysqli_execute", "mysqli_get_client_stats", "mysqli_get_links_stats", "mysqli_report"),
    "Apache": (
    ...
    "Bzip2": ("bzclose", "bzcompress", "bzdecompress", "bzerrno", "bzerror", "bzerrstr", "bzflush", "bzopen", "bzread", "bzwrite"),
    "COM": (
        "com_create_guid",
        "com_event_sink",
    ...
    "Direct IO": ("dio_close", "dio_fcntl", "dio_open", "dio_read", "dio_seek", "dio_stat", "dio_tcsetattr", "dio_truncate", "dio_write"),
    ...
    "Filter": ("filter_has_var", "filter_id", "filter_input_array", "filter_input", "filter_list", "filter_var_array", "filter_var"),
    "Firebird/InterBase": (
        "fbird_add_user",
        "fbird_affected_rows",
        "fbird_backup",
    ...
    "Gettext": ("bind_textdomain_codeset", "bindtextdomain", "dcgettext", "dcngettext", "dgettext", "dngettext", "gettext", "ngettext", "textdomain"),
    "GnuPG": (
        "gnupg_adddecryptkey",
        "gnupg_addencryptkey",
        "gnupg_addsignkey",
    ...
    "Password Hashing": ("password_algos", "password_get_info", "password_hash", "password_needs_rehash", "password_verify"),
    "PostgreSQL": (
        "pg_affected_rows",
        "pg_cancel_query",
        "pg_client_encoding",
    ...
    "Tidy": ("ob_tidyhandler", "tidy_access_count", "tidy_config_count", "tidy_error_count", "tidy_get_output", "tidy_warning_count"),
    ...
    "WDDX": ("wddx_add_vars", "wddx_deserialize", "wddx_packet_end", "wddx_packet_start", "wddx_serialize_value", "wddx_serialize_vars"),
    "WinCache": (
                ...
                for line in f:
                    if not module:
                        ...
                        for match in function_re.finditer(line):
                            fn = match.group(1)
                            if "»" not in fn and "«" not in fn and "::" not in fn and "\\" not in fn and fn not in modules[module]:
