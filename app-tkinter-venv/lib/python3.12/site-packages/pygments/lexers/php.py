...
class ZephirLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(Array|Boolean|Date|_REQUEST|_COOKIE|_SESSION|" r"_GET|_POST|_SERVER|this|stdClass|range|count|iterator|" r"window)\b", Name.Builtin),
...
class PhpLexer(RegexLexer):
    ...
    tokens = {
        ...
        "attribute": [(r"\]", Punctuation, "#pop"), (r"\(", Punctuation, "attributeparams"), (_ident_inner, Name.Decorator), include("php")],
