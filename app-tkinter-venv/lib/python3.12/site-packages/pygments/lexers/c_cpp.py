...
class CFamilyLexer(RegexLexer):
    ...
    tokens = {
        ...
        "types": [
            ...
            (
                words(("bool", "int", "long", "float", "short", "double", "char", "unsigned", "signed", "void", "_BitInt", "__int128"), suffix=r"\b"),
                Keyword.Type,
            ),
        ],
        "keywords": [
...
class CppLexer(CFamilyLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                words(
                    ("virtual_inheritance", "uuidof", "super", "single_inheritance", "multiple_inheritance", "interface", "event"),
                    prefix=r"__",
                    suffix=r"\b",
                ),
                Keyword.Reserved,
