...
class ModelicaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(block|class|connector|end|function|model|operator|package|" r"record|type)\b", Keyword.Reserved, "class"),
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"({})(\s*)(\{{)".format(
                    r"|".join(
                        ("functions", "data", r"transformed\s+?data", "parameters", r"transformed\s+parameters", "model", r"generated\s+quantities")
                    )
                ),
            ...
            # a range constraint
            (r"(<)(\s*)(upper|lower|offset|multiplier)(\s*)(=)", bygroups(Operator, Whitespace, Keyword, Whitespace, Punctuation)),
            ...
            (r"(~)(\s*)({})(?=\s*\()".format("|".join(_stan_builtins.DISTRIBUTIONS)), bygroups(Operator, Whitespace, Name.Builtin)),
