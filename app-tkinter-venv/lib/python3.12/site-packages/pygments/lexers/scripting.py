...
class LuaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "base": [
            ...
            (
                words(["break", "do", "else", "elseif", "end", "for", "if", "in", "repeat", "return", "then", "until", "while"], suffix=r"\b"),
                Keyword.Reserved,
            ),
    ...
    tokens = {
        ...
        "base": [
            ...
            *_luau_make_expression_special(False),
            ...
            (words(("elseif", "for", "if", "in", "repeat", "return", "until", "while"), suffix=r"\b"), Keyword.Reserved, "expression"),
        ...
        "expression_static": [
            (
                words(
                    ("break", "continue", "do", "else", "elseif", "end", "for", "if", "in", "repeat", "return", "then", "until", "while"),
                    suffix=r"\b",
                ),
                Keyword.Reserved,
            ),
...
class AppleScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"\b((?:considering|ignoring)\s*)" r"(application responses|case|diacriticals|hyphens|" r"numeric strings|punctuation|white space)",
...
class RexxLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"([a-z_]\w*)(\s*)(:)(\s*)(procedure)\b", bygroups(Name.Function, Whitespace, Operator, Whitespace, Keyword.Declaration)),
...
class MOOCodeLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Keywords
            (
                r"\b(if|else|elseif|endif|for|endfor|fork|endfork|while" r"|endwhile|break|continue|return|try" r"|except|endtry|finally|in)\b",
                Keyword,
            ),
            # builtins
...
class HybrisLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            # method names
            (r"^(\s*(?:function|method|operator\s+)+?)" r"([a-zA-Z_]\w*)" r"(\s*)(\()", bygroups(Keyword, Name.Function, Text, Operator)),
            (r"[^\S\n]+", Text),
            (r"//.*?\n", Comment.Single),
            (r"/\*.*?\*/", Comment.Multiline),
            (r"@[a-zA-Z_][\w.]*", Name.Decorator),
            (r"(break|case|catch|next|default|do|else|finally|for|foreach|of|" r"unless|if|new|return|switch|me|throw|try|while)\b", Keyword),
...
class JclLexer(RegexLexer):
    ...
    tokens = {
        ...
        "statement": [
            (r"\s*\n", Whitespace, "#pop"),
            (r"([a-z]\w*)(\s+)(exec|job)(\s*)", bygroups(Name.Label, Whitespace, Keyword.Reserved, Whitespace), "option"),
            (r"[a-z]\w*", Name.Variable, "statement_command"),
            (r"\s+", Whitespace, "statement_command"),
        ],
        "statement_command": [
            (r"\s+(command|cntl|dd|endctl|endif|else|include|jcllib|" r"output|pend|proc|set|then|xmit)\s+", Keyword.Reserved, "option"),
            include("option"),
        ],
        "jes2_statement": [
            (r"\s*\n", Whitespace, "#pop"),
            (r"\$", Keyword, "option"),
            (r"\b(jobparam|message|netacct|notify|output|priority|route|" r"setup|signoff|xeq|xmit)\b", Keyword, "option"),
        ],
        "option": [
            # (r'\n', Text, 'root'),
            (r"\*", Name.Builtin),
...
class MiniScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "base": [
            ...
            (r"[;,\[\]{}()]", Punctuation),
            (
                words(("break", "continue", "else", "end", "for", "function", "if", "in", "isa", "then", "repeat", "return", "while"), suffix=r"\b"),
                Keyword,
            ),
            (
                words(
