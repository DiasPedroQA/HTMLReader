...
class WhileyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (words(("function", "method", "public", "private", "protected", "export", "native"), suffix=r"\b"), Keyword.Declaration),
            # "constant" & "type" are not keywords unless used in declarations
            (r"(constant|type)(\s+)([a-zA-Z_]\w*)(\s+)(is)\b", bygroups(Keyword.Declaration, Text, Name, Text, Keyword.Reserved)),
