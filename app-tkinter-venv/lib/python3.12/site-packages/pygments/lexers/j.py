...
class JLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(noun)(\s+)(define)(\s*)$", bygroups(Name.Entity, Whitespace, Name.Entity, Whitespace), "nounDefinition"),
            (r"([1-4]|13)\s+:\s*0\b", Name.Function, "explicitDefinition"),
            (r"(adverb|conjunction|dyad|monad|verb)(\s+)(define)\b", bygroups(Name.Function, Whitespace, Name.Function), "explicitDefinition"),
            # Flow Control
