    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        tokens = {
            "statements": [
                ...
                (words(("id", "instancetype", "Class", "IMP", "SEL", "BOOL", "IBOutlet", "IBAction", "unichar"), suffix=r"\b"), Keyword.Type),
                (r"@(true|false|YES|NO)\n", Name.Builtin),
...
class LogosLexer(ObjectiveCppLexer):
    ...
    tokens = {
        "statements": [
            ...
            (r"(%c)\b(\()(\s*)([a-zA-Z$_][\w$]*)(\s*)(\))", bygroups(Keyword, Punctuation, Text, Name.Class, Text, Punctuation)),
...
class SwiftLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            ...
            (r"(class|enum|extension|struct|protocol)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Declaration, Whitespace, Name.Class)),
        ...
        "preproc": [(r"\n", Whitespace, "#pop"), include("keywords"), (r"[A-Za-z]\w*", Comment.Preproc), include("root")],
        "string": [
            (r'"', String, "#pop"),
        ...
        "string-common": [
            ...
            (r"""\\['"\\nrt]|\\x[0-9a-fA-F]{2}|\\[0-7]{1,3}""" r"""|\\u[0-9a-fA-F]{4}|\\U[0-9a-fA-F]{8}""", String.Escape),
            (r'[^\\"]+', String),
            (r"\\", String),
        ],
