...
class AtomsLexer(RegexLexer):
    ...
    tokens = {
        ...
        "archetype_id": [
            (
                r"([ \t]*)(([a-zA-Z]\w+(\.[a-zA-Z]\w+)*::)?[a-zA-Z]\w+(-[a-zA-Z]\w+){2}" r"\.\w+[\w-]*\.v\d+(\.\d+){,2}((-[a-z]+)(\.\d+)?)?)",
        ...
        "ordered_values": [
            ...
            # ISO 8601 duration
            (r"P((\d*(\.\d+)?[YyMmWwDd]){1,3}(T(\d*(\.\d+)?[HhMmSs]){,3})?|" r"T(\d*(\.\d+)?[HhMmSs]){,3})", Literal.Date),
        ...
        "constraint_values": [
            ...
            (r"(\d*)(\|)(\[\w[\w-]*::\w[\w-]*\])((?:[,;])?)", bygroups(Number, Punctuation, Name.Decorator, Punctuation)),
...
class CadlLexer(AtomsLexer):
    ...
    tokens = {
        ...
        "root": [
            include("whitespace"),
            (r"(cardinality|existence|occurrences|group|include|exclude|" r"allow_archetype|use_archetype|use_node)\W", Keyword.Type),
...
class AdlLexer(AtomsLexer):
    ...
    tokens = {
        ...
        "odin_section": [
            ...
            (
                r"^(language|description|ontology|terminology|annotations|" r"component_terminologies|revision_history)([ \t]*\n)",
