...
class UniconLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(#line|\$C|\$Cend|\$define|\$else|\$endif|\$error|\$ifdef|" r"\$ifndef|\$include|\$line|\$undef)\b", Keyword.PreProc),
...
class UcodeLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    ("con", "declend", "end", "global", "impl", "invocable", "lab", "link", "local", "record", "uid", "unions", "version"),
                    prefix=r"\b",
                    suffix=r"\b",
                ),
                Name.Function,
