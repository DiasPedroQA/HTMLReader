...
class ECLexer(CLexer):
    ...
    tokens = {
        "statements": [
            ...
            (words(("uint", "uint16", "uint32", "uint64", "bool", "byte", "unichar", "int64"), suffix=r"\b"), Keyword.Type),
            (r"(class)(\s+)", bygroups(Keyword, Whitespace), "classname"),
...
class PromelaLexer(CLexer):
    ...
    tokens = {
        ...
        "keywords": [
            # ControlFlow
            (words(("atomic", "break", "d_step", "do", "od", "for", "in", "goto", "if", "fi", "unless"), suffix=r"\b"), Keyword),
            # BasicStatements
            ...
            (words(("empty", "enabled", "eval", "full", "len", "nempty", "nfull", "pc_value"), suffix=r"\b"), Name.Function),
