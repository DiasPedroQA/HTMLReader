...
class FactorLexer(RegexLexer):
    ...
    builtin_arrays = words(
        ("1array", "2array", "3array", "4array", "<array>", ">array", "array", "array?", "pair", "pair?", "resize-array"), suffix=r"(\s+)"
    )
    ...
    tokens = {
        ...
        "base": [
            ...
            (r"(HOOK:|GENERIC#)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Function, Whitespace, Name.Function)),
            ...
            (r"(QUALIFIED-WITH:)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword.Namespace, Whitespace, Name.Namespace, Whitespace, Name.Namespace)),
            (r"(FROM:|EXCLUDE:)(\s+)(\S+)(\s+=>\s)", bygroups(Keyword.Namespace, Whitespace, Name.Namespace, Whitespace), "words"),
            (
                r"(RENAME:)(\s+)(\S+)(\s+)(\S+)(\s+)(=>)(\s+)(\S+)",
                bygroups(
                    Keyword.Namespace, Whitespace, Name.Function, Whitespace, Name.Namespace, Whitespace, Punctuation, Whitespace, Name.Function
                ),
            ),
            (r"(ALIAS:|TYPEDEF:)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword.Namespace, Whitespace, Name.Function, Whitespace, Name.Function)),
            ...
            (r"(PREDICATE:)(\s+)(\S+)(\s+)(<)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Class, Whitespace, Punctuation, Whitespace, Name.Class)),
            (r"(C:)(\s+)(\S+)(\s+)(\S+)", bygroups(Keyword, Whitespace, Name.Function, Whitespace, Name.Class)),
            ...
            (
                ...
                bygroups(
                    Keyword.Namespace, Whitespace, Text, Whitespace, Name.Function, Whitespace, Punctuation, Whitespace, Text, Punctuation, Whitespace
                ),
            ),
            (
        ...
        "slots": [
            ...
            (r"(\{)(\s+)(\S+)(\s+)([^}]+)(\s+)(\})(\s+)", bygroups(Text, Whitespace, Name.Variable, Whitespace, Text, Whitespace, Text, Whitespace)),
            (r"\S+", Name.Variable),
        ],
        "vocabs": [
            (r"\s+", Whitespace),
