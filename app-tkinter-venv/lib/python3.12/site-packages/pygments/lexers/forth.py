    ...
    tokens = {
        "root": [
            ...
            (
                ...
                # *** Wordset DOUBLE
                r"2constant|2literal|2variable|d\+|d-|" r"d\.|d\.r|d0<|d0=|d2\*|d2\/|d<|d=|d>s|" r"dabs|dmax|dmin|dnegate|m\*\/|m\+|"
                # *** Wordset DOUBLE-EXT
                r"2rot|du<|"
                # *** Wordset EXCEPTION
                r"catch|throw|"
                ...
                # *** Wordset SEARCH
                r"definitions|find|forth-wordlist|get-current|" r"get-order|search-wordlist|set-current|set-order|" r"wordlist|"
                # *** Wordset SEARCH-EXT
