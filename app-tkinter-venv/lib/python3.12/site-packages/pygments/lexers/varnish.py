...
class VCLLexer(RegexLexer):
    ...
    tokens = {
        ...
        "statements": [
            ...
            (r"(pipe|retry|hash|synth|deliver|purge|abandon|lookup|pass|fail|ok|" r"miss|fetch|restart)\b", Name.Constant),
            ...
            (r"([a-zA-Z_]\w*)" r"(\.)" r"([a-zA-Z_]\w*)" r"(\s*\(.*\))", bygroups(Name.Function, Punctuation, Name.Function, using(this))),
            (r"[a-zA-Z_]\w*", Name),
        ],
        "comment": [
            (r"[^*/]+", Comment.Multiline),
