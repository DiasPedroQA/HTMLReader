...
class BlitzMaxLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (rf"\b(Import|Framework|Module)([ \t]+)({bmax_name}\.{bmax_name})", bygroups(Keyword.Reserved, Whitespace, Keyword.Namespace)),
            (
                bmax_func,
                bygroups(
                    Name.Function,
...
class BlitzBasicLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (rf"\b(Object)\b([ \t]*)([.])([ \t]*)({bb_name})\b", bygroups(Operator, Whitespace, Punctuation, Whitespace, Name.Class)),
            (
                rf"\b{bb_var}\b([ \t]*)(\()",
                bygroups(Name.Function, Whitespace, Keyword.Type, Whitespace, Punctuation, Whitespace, Name.Class, Whitespace, Punctuation),
            ),
            (
                rf"\b(Function)\b([ \t]+){bb_var}",
                bygroups(Keyword.Reserved, Whitespace, Name.Function, Whitespace, Keyword.Type, Whitespace, Punctuation, Whitespace, Name.Class),
            ),
...
class CbmBasicV2Lexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"tab|spc|sgn|int|abs|usr|fre|pos|sqr|rnd|log|exp|cos|sin|tan|atn" r"|peek|len|val|asc|(str|chr|left|right|mid)\$", Name.Builtin),
            (r"[-+*/^<>=]", Operator),
...
class QBasicLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(DECLARE)(\s+)([A-Z]+)(\s+)(\S+)", bygroups(Keyword.Declaration, Text.Whitespace, Name.Variable, Text.Whitespace, Name)),
            (
                r"(DIM)(\s+)(SHARED)(\s+)([^\s(]+)",
            ...
            (r"^(\s*)([a-zA-Z_]+)(\s*)(\=)", bygroups(Text.Whitespace, Name.Variable.Global, Text.Whitespace, Operator)),
...
class VBScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(on)(\s+)(error)(\s+)(goto)(\s+)(0)", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword, Whitespace, Number.Integer)),
            (r"(on)(\s+)(error)(\s+)(resume)(\s+)(next)", bygroups(Keyword, Whitespace, Keyword, Whitespace, Keyword, Whitespace, Keyword)),
...
class BBCBasicLexer(RegexLexer):
    ...
    tokens = {
        ...
        "code": [
            ...
            (r"(DEF)(\s*)(FN|PROC)([A-Za-z_@][\w@]*)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration, Name.Function)),
