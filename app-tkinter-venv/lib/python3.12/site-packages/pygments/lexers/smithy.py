...
class SmithyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (words(simple_shapes, prefix=r"^", suffix=r"(\s+" + identifier + r")\b"), bygroups(Keyword.Declaration, Name.Class)),
            (words(aggregate_shapes, prefix=r"^", suffix=r"(\s+" + identifier + r")"), bygroups(Keyword.Declaration, Name.Class)),
            (r'^(metadata)(\s+)((?:\S+)|(?:\"[^"]+\"))(\s*)(=)', bygroups(Keyword.Declaration, Whitespace, Name.Class, Whitespace, Name.Decorator)),
