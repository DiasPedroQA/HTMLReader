...
class PraatLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(print(?:line|tab)?|echo|exit|asserterror|pause|send(?:praat|socket)|" r"include|execute|system(?:_nocheck)?)(\s+)",
        ...
        "procedure_call": [
            (r"\s+", Whitespace),
            (r"([\w.]+)(?:(:)|(?:(\s*)(\()))", bygroups(Name.Function, Punctuation, Text.Whitespace, Punctuation), "#pop"),
        ...
        "old_form": [
            (r"(\s+)(#.*?$)", bygroups(Whitespace, Comment.Single)),
            (r"\s+", Whitespace),
            (r"(optionmenu|choice)([ \t]+)(\S+)(:)([ \t]+)", bygroups(Keyword, Whitespace, Text, Punctuation, Whitespace), "number"),
            ...
            (r"(word)([ \t]+)(\S+)([ \t]*)(\S+)?(?:([ \t]+)(.*))?", bygroups(Keyword, Whitespace, Text, Whitespace, Text, Whitespace, Text)),
