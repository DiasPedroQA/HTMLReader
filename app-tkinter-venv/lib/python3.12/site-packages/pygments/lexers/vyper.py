...
class VyperLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # indexed keywords
            (r"\b(indexed)\b(\s*)(\()(\s*)(\w+)(\s*)(\))", bygroups(Keyword, Whitespace, Punctuation, Whitespace, Keyword.Type, Punctuation)),
        ...
        "multiline-comment": [(r"\"\"\"", Comment.Multiline, "#pop"), (r'[^"]+', Comment.Multiline), (r"\"", Comment.Multiline)],
        "single-string": [
            (r"[^\\']+", String.Single),
            (r"'", String.Single, "#pop"),
            (r"\\.", String.Escape),
