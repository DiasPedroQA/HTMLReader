...
class TactLexer(RegexLexer):
    ...
    tokens = {
        ...
        "fun-declaration-in": [(r"(?=\b(?:(?:get|native|extends|mutates|virtual|override|inline|abstract)\s*)*fun\b)", Keyword, "fun-declaration")],
        "fun-declaration": [
            (r"(?<=\}|\;)", Punctuation, "#pop"),
            (r"fun", Keyword),
        ...
        "struct-property-in": [(r"(\b[\w]+)(\s*)(:)", bygroups(Name.Property, Whitespace, Punctuation), "struct-property")],
        "struct-property": [
            (r"(?=\}|\,)", Punctuation, "#pop"),
            include("comments"),
            include("expressions"),
