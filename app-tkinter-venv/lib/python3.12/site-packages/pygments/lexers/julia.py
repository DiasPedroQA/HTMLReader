...
from pygments.lexers._julia_builtins import BUILTIN_LIST, DOTTED_OPERATORS_LIST, KEYWORD_LIST, LITERAL_LIST, OPERATORS_LIST
...
class JuliaLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(" + allowed_variable + r")(\s*)(:)(" + allowed_variable + ")", bygroups(Name, Whitespace, Operator, Name)),
            ...
            (r"(abstract|primitive)([ \t]+)(type\b)([\s()]+)(" + allowed_variable + r")", bygroups(Keyword, Whitespace, Keyword, Text, Keyword.Type)),
            (
            ...
            (words([*OPERATORS_LIST, "..", ".", *DOTTED_OPERATORS_LIST], prefix="@", suffix=operator_suffixes), Name.Decorator),
            # keywords
