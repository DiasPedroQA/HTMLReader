...
from pygments.token import Comment, Error, Keyword, Name, Number, Operator, Other, Punctuation, String, Text, Token, Whitespace
...
class SmartyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(\{php\})(.*?)(\{/php\})", bygroups(Comment.Preproc, using(PhpLexer, startinline=True), Comment.Preproc)),
...
class VelocityLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(#\{?)(" + identifier + r")(\}?)(\s?\()", bygroups(Comment.Preproc, Name.Function, Comment.Preproc, Punctuation), "directiveparams"),
...
class DjangoLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # filter blocks
            (r"(\{%)(-?\s*)(filter)(\s+)([a-zA-Z_]\w*)", bygroups(Comment.Preproc, Text, Keyword, Text, Name.Function), "block"),
        ...
        "varnames": [
            ...
            (r"(in|as|reversed|recursive|not|and|or|is|if|else|import|" r"with(?:(?:out)?\s*context)?|scoped|ignore\s+missing)\b", Keyword),
        ...
        "block": [(r"\s+", Text), (r"(-?)(%\})", bygroups(Text, Comment.Preproc), "#pop"), include("varnames"), (r".", Punctuation)],
    }
...
class MyghtyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            (r"\s+", Text),
            (r"(?s)(<%(?:def|method))(\s*)(.*?)(>)(.*?)(</%\2\s*>)", bygroups(Name.Tag, Text, Name.Function, Name.Tag, using(this), Name.Tag)),
            (r"(?s)(<%\w+)(.*?)(>)(.*?)(</%\2\s*>)", bygroups(Name.Tag, Name.Function, Name.Tag, using(PythonLexer), Name.Tag)),
...
class MasonLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?s)(<%(?:def|method))(\s*)(.*?)(>)(.*?)(</%\2\s*>)", bygroups(Name.Tag, Whitespace, Name.Function, Name.Tag, using(this), Name.Tag)),
            (r"(?s)(<%(\w+)(.*?)(>))(.*?)(</%\2\s*>)", bygroups(Name.Tag, None, None, None, using(PerlLexer), Name.Tag)),
...
class EvoqueLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(\$)(begin|end)(\{(%)?)(.*?)((?(4)%)\})", bygroups(Punctuation, Name.Builtin, Punctuation, None, String, Punctuation)),
            ...
            (r"(\$)(\w+)(\{(%)?)(.*?)((?(4)%)\})", bygroups(Punctuation, Name.Builtin, Punctuation, None, using(PythonLexer), Punctuation)),
            # directive clauses (no {} expression)
            (r"(\$)(else|rof|fi)", bygroups(Punctuation, Name.Builtin)),
            # expressions
            (r"(\$\{(%)?)(.*?)((!)(.*?))?((?(2)%)\})", bygroups(Punctuation, None, using(PythonLexer), Name.Builtin, None, None, Punctuation)),
            (r"#", Other),
        ],
        "comment": [
            (r"[^\]#]", Comment.Multiline),
...
class LiquidLexer(RegexLexer):
    ...
    tokens = {
        ...
        "output": [include("whitespace"), (r"\}\}", Punctuation, "#pop"), (r"\|", Punctuation, "filters")],  # end of output
        "filters": [
            include("whitespace"),
        ...
        "param-markup": [
            ...
            # explicit variables
            (r"(\{\{)(\s*)([^\s}])(\s*)(\}\})", bygroups(Punctuation, Whitespace, using(this, state="variable"), Whitespace, Punctuation)),
            include("string"),
            include("number"),
            include("keyword"),
            (r",", Punctuation),
        ],
        "default-param-markup": [include("param-markup"), (r".", Text)],  # fallback for switches / variables / un-quoted strings / ...
        ...
        "variable-tag-markup": [(r"%\}", Punctuation, ("#pop", "#pop")), include("variable-param-markup")],  # end of tag
        ...
        "generic": [include("keyword"), include("string"), include("number"), include("variable")],  # decides for variable, string, keyword or number
...
class TwigLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # filter blocks
            (rf"(\{{%)(-?\s*)(filter)(\s+)({_ident_inner})", bygroups(Comment.Preproc, Text, Keyword, Text, Name.Function), "tag"),
...
class Angular2Lexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"([([]+)([\w:.-]+)([\])]+)(\s*)(=)(\s*)", bygroups(Punctuation, Name.Attribute, Punctuation, Text, Operator, Text), "attr"),
