...
from pygments.token import Comment, Generic, Keyword, Literal, Name, Number, Operator, Other, Punctuation, String, Text, Whitespace
...
class RstLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # A reference target
            (r"^( *\.\.)(\s*)(_(?:[^:\\]|\\.)+:)(.*?)$", bygroups(Punctuation, Text, Name.Tag, using(this, state="inline"))),
...
class OrgLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"^(?:( *)([+-] )|( +)(\* ))(\[[ X-]\])?(.+ ::)?", bygroups(Whitespace, Keyword, Whitespace, Keyword, Generic.Prompt, Name.Label)),
            # Ordered list items
            (r"^( *)([0-9]+[.)])( \[@[0-9]+\])?", bygroups(Whitespace, Keyword, Generic.Emph)),
            # Dynamic blocks
            (r"(?i)^( *#\+begin: *)((?:.|\n)*?)(^ *#\+end: *$)", bygroups(Operator.Word, using(this), Operator.Word)),
            # Comment blocks
            (r"(?i)^( *#\+begin_comment *\n)((?:.|\n)*?)(^ *#\+end_comment *$)", bygroups(Operator.Word, Comment.Multiline, Operator.Word)),
            # Source code blocks
            # TODO: language-dependent syntax highlighting (see Markdown lexer)
            (r"(?i)^( *#\+begin_src .*)((?:.|\n)*?)(^ *#\+end_src *$)", bygroups(Operator.Word, Text, Operator.Word)),
            # Other blocks
            (r"(?i)^( *#\+begin_\w+)( *\n)((?:.|\n)*?)(^ *#\+end_\w+)( *$)", bygroups(Operator.Word, Whitespace, Text, Operator.Word, Whitespace)),
            # Keywords
            ...
            (r"(?<!\[)\[fn:.+?\]", Name.Tag),
            # Links
            (r"(?s)(\[\[)(.*?)(\]\[)(.*?)(\]\])", bygroups(Punctuation, Name.Attribute, Punctuation, Name.Tag, Punctuation)),
...
class TiddlyWiki5Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            (words(("\\define", "\\end", "caption", "created", "modified", "tags", "title", "type"), prefix=r"^", suffix=r"\b"), Keyword),
        ],
        "inline": [
            # escape
            (r"\\.", Text),
...
class WikitextLexer(RegexLexer):
    ...
    def plaintext_tag_rules(tag_name):
        return [
            (rf"(?si)(.*?)(</)({tag_name})(\s*)(>)", bygroups(Text, Punctuation, Name.Tag, Whitespace, Punctuation), "#pop"),
        ]
    ...
    tokens = {
        ...
        "inline": [
            ...
            (
                ...
                bygroups(Punctuation, Name.Namespace, Punctuation, using(this, state=["wikilink-name"]), Punctuation, Name.Label),
                "medialink-inner",
            ),
            # Wikilinks
            (
                ...
                bygroups(Punctuation, Name.Namespace, Punctuation, using(this, state=["wikilink-name"]), Punctuation, Name.Label, Punctuation),
            ),
            (
                r"""(?xi)
                (\[\[)(?!{})
            ...
            # Tables
            (r"^(:*)(\s*?)(\{\|)([^\n]*)$", bygroups(Keyword, Whitespace, Punctuation, using(this, state=["root", "attr"])), "table"),
            # HTML tags
            (r"(?i)(<)({})\b".format("|".join(html_tags)), bygroups(Punctuation, Name.Tag), "tag-inner-ordinary"),
            (r"(?i)(</)({})\b(\s*)(>)".format("|".join(html_tags)), bygroups(Punctuation, Name.Tag, Whitespace, Punctuation)),
            # <nowiki>
            ...
            (r"(?si)(<)(syntaxhighlight)\b([^>]*?(?<!/)>.*?)(?=</\2\s*>)", bygroups(Punctuation, Name.Tag, handle_syntaxhighlight)),
            ...
            (r"(?si)(<)(source)\b([^>]*?(?<!/)>.*?)(?=</\2\s*>)", bygroups(Punctuation, Name.Tag, handle_syntaxhighlight)),
            ...
            (r"(?i)(</)({})\b(\s*)(>)".format("|".join(parser_tags)), bygroups(Punctuation, Name.Tag, Whitespace, Punctuation)),
            ...
            (
                ...
                bygroups(Punctuation, Keyword, Punctuation, using(this, state=["root", "lc-raw"]), Operator, Name.Label, Punctuation),
                "lc-inner",
            ),
        ...
        "template-begin-space": [
            ...
            (r"({})(:)".format("|".join(parser_functions)), bygroups(Name.Function, Punctuation), ("#pop", "template-inner")),
            # Templates
        ...
        "table": [
            ...
            # Table rows
            (r"^([ \t\n\r\0\x0B]*?)(\|-+)(.*)$", bygroups(Whitespace, Punctuation, using(this, state=["root", "attr"]))),
            # Captions
            (
                r"""(?x)
                ^([ \t\n\r\0\x0B]*?)(\|\+)
