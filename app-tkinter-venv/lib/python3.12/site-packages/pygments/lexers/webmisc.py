...
class XQueryLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "itemtype": [
            ...
            (
                r"(element|attribute|schema-element|schema-attribute|comment|text|" r"node|binary|document-node|empty-sequence)(\s*)(\()",
        ...
        "root": [
            ...
            (r"(declare)(\s+)(default)(\s+)(order)", bygroups(Keyword.Declaration, Text, Keyword.Declaration, Text, Keyword.Declaration), "operator"),
            (r"(declare)(\s+)(context)(\s+)(item)", bygroups(Keyword.Declaration, Text, Keyword.Declaration, Text, Keyword.Declaration), "operator"),
            ...
            (r"(module|declare)(\s+)(namespace)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration), "namespacedecl"),
            (r"(declare)(\s+)(base-uri)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration), "namespacedecl"),
            # NAMESPACE KEYWORD
            (
            ...
            (r"(declare)(\s+)(copy-namespaces)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration), "namespacekeyword"),
            # VARNAMEs
            ...
            (
                r"(element|attribute|schema-element|schema-attribute|comment|" r"text|node|document-node|empty-sequence)(\s+)(\()",
            ...
            (r"(declare)(\s+)(boundary-space)", bygroups(Keyword.Declaration, Text, Keyword.Declaration), "xmlspace_decl"),
            ...
            (r"(declare)(\s+)(ordering)", bygroups(Keyword.Declaration, Whitespace, Keyword.Declaration), "declareordering"),
            ...
            (r"(descendant|following-sibling|following|parent|preceding-sibling" r"|preceding|self)(::)", bygroups(Keyword, Punctuation)),
...
class QmlLexer(RegexLexer):
    ...
    tokens = {
        "commentsandwhitespace": [(r"\s+", Text), (r"<!--", Comment), (r"//.*?\n", Comment.Single), (r"/\*.*?\*/", Comment.Multiline)],
        "slashstartsregex": [
