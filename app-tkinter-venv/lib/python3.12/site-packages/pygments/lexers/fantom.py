...
class FantomLexer(RegexLexer):
    ...
    tokens = {
        ...
        "literals": [
            ...
            (r"(?:(\w+)(::))?(\w+)(<\|)(.*?)(\|>)", bygroups(Name.Namespace, Punctuation, Name.Class, Punctuation, String, Punctuation)),  # DSL
            (r"(?:(\w+)(::))?(\w+)?(#)(\w+)?", bygroups(Name.Namespace, Punctuation, Name.Class, Punctuation, Name.Function)),  # Type/slot literal
        ...
        "root": [
            ...
            # Type var := val
            (s(r"($type)([ \t]+)($id)(\s*)(:=)"), bygroups(using(this, state="inType"), Whitespace, Name.Variable, Whitespace, Operator)),
            # var := val
            (s(r"($id)(\s*)(:=)"), bygroups(Name.Variable, Whitespace, Operator)),
            # .someId( or ->someId( ###
            (s(r"(\.|(?:\->))($id)(\s*)(\()"), bygroups(Operator, Name.Function, Whitespace, Punctuation), "insideParen"),
            # .someId  or ->someId
            (s(r"(\.|(?:\->))($id)"), bygroups(Operator, Name.Function)),
            # new makeXXX (
            (r"(new)(\s+)(make\w*)(\s*)(\()", bygroups(Keyword, Whitespace, Name.Function, Whitespace, Punctuation), "insideMethodDeclArgs"),
            # Type name (
            (
                s(
            ...
            # ArgType argName,
            (s(r"($type)(\s+)($id)(\s*)(,)"), bygroups(using(this, state="inType"), Whitespace, Name.Variable, Whitespace, Punctuation)),
            # ArgType argName)
        ...
        "insideMethodDeclArgs": [
            (r"\)", Punctuation, "#pop"),
            (s(r"($type)(\s+)($id)(\s*)(\))"), bygroups(using(this, state="inType"), Whitespace, Name.Variable, Whitespace, Punctuation), "#pop"),
            include("root"),
        ],
        "insideBrace": [
            (r"\}", Punctuation, "#pop"),
