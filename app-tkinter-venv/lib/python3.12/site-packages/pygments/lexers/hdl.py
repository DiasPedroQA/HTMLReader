...
class SystemVerilogLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(endclass\b)(?:(\s*)(:)(\s*)([a-zA-Z_]\w*))?", bygroups(Keyword.Declaration, Whitespace, Punctuation, Whitespace, Name.Class)),
            (
                words(
                    (
                        # Variable types
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(Keyword, Whitespace, Name.Class, Whitespace, Keyword, Whitespace, Name.Class, Whitespace, Keyword),
            ),
