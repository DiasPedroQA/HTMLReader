...
class CsoundLexer(RegexLexer):
    ...
    tokens = {
        ...
        "macro body": [(r"(?:\\(?!#)|[^#\\]|\n)+", Comment.Preproc), (r"\\#", Comment.Preproc), (r"(?<!\\)#", Punctuation, "#pop")],
        ...
        "macro parameter value quoted string": [(r"\\[#'()]", Comment.Preproc), (r"[#'()]", Error), include("quoted string")],
        "macro parameter value braced string": [(r"\\[#'()]", Comment.Preproc), (r"[#'()]", Error), include("braced string")],
...
class CsoundScoreLexer(CsoundLexer):
    ...
    tokens = {
        ...
        "mark statement": [include("whitespace and macro uses"), (r"[A-Z_a-z]\w*", Name.Label), (r"\n", Whitespace, "#pop")],
        "loop after left brace": [
            include("whitespace and macro uses"),
            (r"\d+", Number.Integer, ("#pop", "loop after repeat count")),
        ],
        "loop after repeat count": [include("whitespace and macro uses"), (r"[A-Z_a-z]\w*", Comment.Preproc, ("#pop", "loop"))],
...
class CsoundOrchestraLexer(CsoundLexer):
    ...
    tokens = {
        ...
        "partial statements": [
            ...
            (r"\b(c(?:g|in?|k|nk?)goto)(\(|\b)", bygroups(Keyword.Pseudo, Punctuation), ("goto label", "goto argument")),
            (r"\b(timout)(\(|\b)", bygroups(Keyword.Pseudo, Punctuation), ("goto label", "goto argument", "goto argument")),
            (r"\b(loop_[gl][et])(\(|\b)", bygroups(Keyword.Pseudo, Punctuation), ("goto label", "goto argument", "goto argument", "goto argument")),
        ...
        "goto argument": [include("whitespace and macro uses"), (r",", Punctuation, "#pop"), include("partial statements")],
        "goto label": [include("whitespace and macro uses"), (r"\w+", Name.Label, "#pop"), default("#pop")],
        "prints opcode": [include("whitespace and macro uses"), (r'"', String, "prints quoted string"), default("#pop")],
        "prints quoted string": [(r"\\\\[aAbBnNrRtT]", String.Escape), (r"%[!nNrRtT]|[~^]{1,2}", String.Escape), include("quoted string")],
        "Csound score opcode": [
            include("whitespace and macro uses"),
            (r'"', String, "quoted string"),
        ...
        "Lua opcode": [include("whitespace and macro uses"), (r'"', String, "quoted string"), (r"\{\{", String, "Lua"), (r"\n", Whitespace, "#pop")],
...
class CsoundDocumentLexer(RegexLexer):
    ...
    tokens = {
        ...
        "orchestra": [(r"<\s*/\s*CsInstruments\s*>", Name.Tag, "#pop"), (r"(.|\n)+?(?=<\s*/\s*CsInstruments\s*>)", using(CsoundOrchestraLexer))],
        "score": [(r"<\s*/\s*CsScore\s*>", Name.Tag, "#pop"), (r"(.|\n)+?(?=<\s*/\s*CsScore\s*>)", using(CsoundScoreLexer))],
        "HTML": [(r"<\s*/\s*[Hh][Tt][Mm][Ll]\s*>", Name.Tag, "#pop"), (r"(.|\n)+?(?=<\s*/\s*[Hh][Tt][Mm][Ll]\s*>)", using(HtmlLexer))],
        "tag": [(r"\s+", Whitespace), (r"[\w.:-]+\s*=", Name.Attribute, "attr"), (r"/?\s*>", Name.Tag, "#pop")],
        "attr": [(r"\s+", Whitespace), (r'".*?"', String, "#pop"), (r"'.*?'", String, "#pop"), (r"[^\s>]+", String, "#pop")],
    }
