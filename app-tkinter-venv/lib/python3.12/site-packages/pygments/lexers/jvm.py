...
class JavaLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(assert|break|case|catch|continue|default|do|else|finally|for|" r"if|goto|instanceof|new|return|switch|this|throw|try|while)\b",
                Keyword,
            ),
            # method names
            (
...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "storage-modifiers": [
            ...
            (r"\b(transparent|opaque|infix|open|inline)\b(?=[a-z\s]*\b" r"(def|val|var|given|type|class|trait|object|enum)\b)", Keyword),
        ],
        "annotations": [
        ...
        "declarations": [
            ...
            (rf"\b(package)(\s+)(object)\b(\s*){notStartOfComment}({anyId})?", bygroups(Keyword, Whitespace, Keyword, Whitespace, Name.Namespace)),
        ...
        "end": [
            ...
            (rf"\b(end)(\s+)({backQuotedId}|{plainid})?{endOfLineMaybeWithComment}", bygroups(Keyword, Whitespace, Name.Namespace)),
        ],
        "punctuation": [
            (r"[{}()\[\];,.]", Punctuation),
            (r"(?<!:):(?!:)", Punctuation),
...
class GosuLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(class|interface|enhancement|enum)(\s+)([a-zA-Z_]\w*)", bygroups(Keyword.Declaration, Whitespace, Name.Class)),
...
class IokeLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(case|case:and|case:else|case:nand|case:nor|case:not|case:or|" r"case:otherwise|case:xor)(?![\w!:?])", Keyword.Reserved),
            ...
            (r"(cell\?|cellOwner\?|cellOwner|cellNames|cells|cell|" r"documentation|identity|removeCell!|undefineCell)" r"(?![\w!:?])", Keyword),
            ...
            (
                r"(availableRestarts|bind|error\!|findRestart|handle|" r"invokeRestart|rescue|restart|signal\!|warn\!)" r"(?![\w!:?])",
                Keyword.Reserved,
            ),
            # constants
...
class KotlinLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"it\b", Name.Builtin),
            # Built-in types
            (words(("Boolean?", "Byte?", "Char?", "Double?", "Float?", "Int?", "Long?", "Short?", "String?", "Any?", "Unit?")), Keyword.Type),
            (words(("Boolean", "Byte", "Char", "Double", "Float", "Int", "Long", "Short", "String", "Any", "Unit"), suffix=r"\b"), Keyword.Type),
            # Constants
            (r"(true|false|null)\b", Keyword.Constant),
            # Imports
            ...
            # Functions
            (r"((?:(?:" + modifiers + r")\s+)*)(fun)(\s+)", bygroups(using(this, state="modifiers"), Keyword.Declaration, Whitespace), "function"),
            # Operators
            (r"::|!!|\?[:.]", Operator),
            (r"[~^*!%&\[\]<>|+=/?-]", Operator),
            # Punctuation
...
class PigLexer(RegexLexer):
    ...
    tokens = {
        ...
        "types": [(r"(bytearray|BIGINTEGER|BIGDECIMAL|chararray|datetime|double|float|" r"int|long|tuple)\b", Keyword.Type)],
        "punct": [
            (r"[;(){}\[\]]", Punctuation),
        ],
        "operators": [
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        "default": [
            ...
            (
                r"(\.class|\.implements|\.inner|\.super|inner|invisible|" rf"invisibleparam|outer|visible|visibleparam){_break}",
                Keyword.Reserved,
                "class/convert-dots",
            ),
            ...
            (r"invoke(dynamic|interface|nonvirtual|special|" rf"static|virtual){_break}", Keyword.Reserved, "invocation"),
        ...
        "string": [(r'"', String.Double, "#pop"), (r'\\([nrtfb"\'\\]|u[\da-fA-F]{4}|[0-3]?[0-7]{1,2})', String.Escape), (r'[^"\\]+', String.Double)],
        "root": [
            (r"\n+", Whitespace),
        ...
        "class/convert-dots": [
            include("default"),
            (rf"(L)((?:{_unqualified_name}[/.])*)({_name})(;)", bygroups(Keyword.Type, Name.Namespace, Name.Class, Punctuation), "#pop"),
        ...
        "enclosing-method": [(_ws, Whitespace), (rf"(?=[^{_separator}]*\()", Text, ("#pop", "invocation")), default(("#pop", "class/convert-dots"))],
        "exception": [include("default"), (rf"((?:{_unqualified_name}[/.])*)({_name})", bygroups(Name.Namespace, Name.Exception), "#pop")],
        "field": [
        ...
        "table": [(r"\n+", Whitespace), (rf"default{_break}", Keyword.Reserved, "#pop"), include("default"), (_name, Name.Label)],
    ...
    def analyse_text(text):
        ...
        if re.search(r"^\s*\.class\s", text, re.MULTILINE):
            ...
            if re.search(r"^\s*[a-z]+_[a-z]+\b", text, re.MULTILINE):
                score += 0.3
        if re.search(r"^\s*\.(attribute|bytecode|debug|deprecated|enclosing|" r"inner|interface|limit|set|signature|stack)\b", text, re.MULTILINE):
            score += 0.6
