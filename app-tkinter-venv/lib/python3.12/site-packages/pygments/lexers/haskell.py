...
class HaskellLexer(RegexLexer):
    ...
    tokens = {
        ...
        "import": [
            ...
            (r"([" + uni.Lu + r"][\w.]*)(\s+)(hiding)(\s+)(\()", bygroups(Name.Namespace, Whitespace, Keyword, Whitespace, Punctuation), "funclist"),
            # import X (functions)
...
class IdrisLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Declaration
            (r"^(\s*)([^\s(){}]+)(\s*)(:)(\s*)", bygroups(Whitespace, Name.Function, Whitespace, Operator.Word, Whitespace)),
            #  Identifiers
            (r"\b({})(?!\')\b".format("|".join(reserved)), Keyword.Reserved),
...
class CryptolLexer(RegexLexer):
    ...
    tokens = {
        ...
        "import": [
            ...
            (r"qualified\b", Keyword),
            # import X as Y
            (r"([A-Z][\w.]*)(\s+)(as)(\s+)([A-Z][\w.]*)", bygroups(Name.Namespace, Whitespace, Keyword, Whitespace, Name), "#pop"),
            # import X hiding (functions)
            (r"([A-Z][\w.]*)(\s+)(hiding)(\s+)(\()", bygroups(Name.Namespace, Whitespace, Keyword, Whitespace, Punctuation), "funclist"),
            # import X (functions)
            (r"([A-Z][\w.]*)(\s+)(\()", bygroups(Name.Namespace, Whitespace, Punctuation), "funclist"),
            # import X
            (r"[\w.]+", Name.Namespace, "#pop"),
...
class KokaLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            ((r"({})".format("|".join(typeStartKeywords))) + r"(\s+)([a-z]\w*)?", bygroups(Keyword, Whitespace, tokenTypeDef), "type"),
            # special sequences of tokens (we use ?: for non-capturing group as
            # required by 'bygroups')
            (r"(module)(\s+)(interface(?=\s))?(\s+)?((?:[a-z]\w*/)*[a-z]\w*)", bygroups(Keyword, Whitespace, Keyword, Whitespace, Name.Namespace)),
            (
                r"(import)(\s+)((?:[a-z]\w*/)*[a-z]\w*)" r"(?:(\s*)(=)(\s*)(qualified)?(\s*)" r"((?:[a-z]\w*/)*[a-z]\w*))?",
                bygroups(Keyword, Whitespace, Name.Namespace, Whitespace, Keyword, Whitespace, Keyword, Whitespace, Name.Namespace),
            ),
            (
            ...
            (
                r"^(?:(public|private)(?=\s+external))?((?<!^)\s+)?(external)(\s+)(inline(?=\s))?(\s+)?" r"([a-z]\w*|\((?:" + symbols + r"|/)\))",
        ...
        "type-content": [
            ...
            (r"(?=(({})".format("|".join(keywords)) + boundary + "))", Keyword, "#pop"),  # need to match because names overlap...
            # kinds
