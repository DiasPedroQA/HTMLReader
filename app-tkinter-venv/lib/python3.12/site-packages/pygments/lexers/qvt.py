...
class QVToLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(metamodel|class|exception|primitive|enum|transformation|" r"library)(\s+)(\w+)", bygroups(Keyword.Word, Text, Name.Class)),
        ...
        "operation": [(r"::", Text), (r"(.*::)([a-zA-Z_]\w*)([ \t]*)(\()", bygroups(Text, Name.Function, Text, Punctuation), "#pop")],
        "assert": [
        ...
        "numbers": [(r"(\d+\.\d*|\d*\.\d+)([eE][+-]?[0-9]+)?", Number.Float), (r"\d+[eE][+-]?[0-9]+", Number.Float), (r"\d+", Number.Integer)],
    }
