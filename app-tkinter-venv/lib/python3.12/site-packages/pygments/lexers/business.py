...
class CobolLexer(RegexLexer):
    ...
    tokens = {
        ...
        "core": [
            ...
            (r"(^|(?<=[^\w\-]))(ALL\s+)?" r"((ZEROES)|(HIGH-VALUE|LOW-VALUE|QUOTE|SPACE|ZERO)(S)?)" r"\s*($|(?=[^\w\-]))", Name.Constant),
...
class ABAPLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(MODULE)(\s+)(\S+)(\s+)(INPUT|OUTPUT)", bygroups(Keyword, Whitespace, Name.Function, Whitespace, Keyword)),
