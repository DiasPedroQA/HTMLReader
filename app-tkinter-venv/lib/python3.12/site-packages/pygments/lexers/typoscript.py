...
class TypoScriptCssDataLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(\{)(\$)((?:[\w\-]+\.)*)([\w\-]+)(\})", bygroups(String.Symbol, Operator, Name.Constant, Name.Constant, String.Symbol)),  # constant
...
class TypoScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            ...
            # Menu objects
            (r"(?=[\w\-])(GMENU_FOLDOUT|GMENU_LAYERS|GMENU|IMGMENUITEM|IMGMENU|" r"JSMENUITEM|JSMENU|TMENUITEM|TMENU_LAYERS|TMENU)", Name.Class),
            # PHP objects
        ...
        "constant": [
            ...
            (r"(\{)(\$)((?:[\w\-]+\.)*)([\w\-]+)(\})", bygroups(String.Symbol, Operator, Name.Constant, Name.Constant, String.Symbol)),  # constant
            # Constant: {register:somevalue}
            (r"(\{)([\w\-]+)(\s*:\s*)([\w\-]+)(\})", bygroups(String.Symbol, Name.Constant, Operator, Name.Constant, String.Symbol)),  # constant
            # Hex color: #ff0077
