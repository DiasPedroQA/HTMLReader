...
class MatlabLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"(\s*^\s*)(properties)(\s+)(\()", bygroups(Whitespace, Keyword, Whitespace, Punctuation), ("defprops", "propattrs")),
            ...
            (rf"(?:^|(?<=;))(\s*)(\w+)(\s+)(?!=|\(|{_operators}\s|\s)", bygroups(Whitespace, Name, Whitespace), "commandargs"),
            include("expressions"),
        ],
        "blockcomment": [
        ...
        "deffunc": [
            (
                r"(\s*)(?:(\S+)(\s*)(=)(\s*))?(.+)(\()(.*)(\))(\s*)",
                bygroups(Whitespace, Text, Whitespace, Punctuation, Whitespace, Name.Function, Punctuation, Text, Punctuation, Whitespace),
                "#pop",
            ),
...
class ScilabLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (words(_scilab_builtins.functions_kw + _scilab_builtins.commands_kw + _scilab_builtins.macros_kw, suffix=r"\b"), Name.Builtin),
