...
from pygments.token import Comment, Keyword, Literal, Name, Number, Operator, Other, Punctuation, String, Text, Whitespace
    ...
    for levelname, cs_ident in levels.items():
        tokens[levelname] = {
            "root": [
                ...
                (r"(file)(\s+)(record|class|abstract|enum|new|sealed|static)\b", bygroups(Keyword, Whitespace, Keyword)),
                (r"(global)(::)", bygroups(Keyword, Punctuation)),
                (r"(bool|byte|char|decimal|double|dynamic|float|int|long|object|" r"sbyte|short|string|uint|ulong|ushort|var)\b\??", Keyword.Type),
    ...
    for levelname, cs_ident in levels.items():
        tokens[levelname] = {
            "root": [
                ...
                (r"(global)(::)", bygroups(Keyword, Punctuation)),
                (
                    r"(bool|byte|char|decimal|double|float|int|long|object|sbyte|" r"short|string|uint|ulong|ushort|void|array|list)\b\??",
                    Keyword.Type,
                ),
            ...
            "namespace": [(r"(?=\()", Text, "#pop"), ("(" + cs_ident + r"|\.)+", Name.Namespace, "#pop")],  # using (resource)
            "splice-string": [
                (r'[^"$]', String),
                (r"\$" + cs_ident, Name),
                (r"(\$)(\()", bygroups(Name, Punctuation), "splice-string-content"),
...
class VbNetLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?<!\.)(AddressOf|And|AndAlso|As|GetType|In|Is|IsNot|Like|Mod|" r"Or|OrElse|TypeOf|Xor)\b", Operator.Word),
            (r"&=|[*]=|/=|\\=|\^=|\+=|-=|<<=|>>=|<<|>>|:=|" r"<=|>=|<>|[-&*/\\^+=<>\[\]]", Operator),
            ('"', String, "string"),
...
class FSharpLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"\b(member|override)(\s+)(\w+)(\.)(\w+)", bygroups(Keyword, Whitespace, Name, Punctuation, Name.Function)),
