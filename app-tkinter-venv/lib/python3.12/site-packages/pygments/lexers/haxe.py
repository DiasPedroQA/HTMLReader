...
class HaxeLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        "abstract": [
            include("spaces"),
            default(("#pop", "abstract-body", "abstract-relation", "abstract-opaque", "type-param-constraint", "type-name")),
        ],
        "abstract-body": [
            include("spaces"),
        ...
        "function-local": [
            include("spaces"),
            (ident_no_keyword, Name.Function, ("#pop", "optional-expr", "flag", "function-param", "parenthesis-open", "type-param-constraint")),
        ...
        "object": [include("spaces"), (r"\}", Punctuation, "#pop"), default(("#pop", "object-sep", "expr", "colon", "ident-or-string"))],
        # a key of an object
        "ident-or-string": [
            include("spaces"),
...
class HxmlLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(--)(neko-source|flash-strict|flash-use-stage|no-opt|no-traces|" r"no-inline|times|no-output)", bygroups(Punctuation, Keyword)),
            ...
            (r"(--)(js-namespace|php-front|php-lib|remap|gen-hx-classes)( +)" r"(.+)", bygroups(Punctuation, Keyword, Whitespace, String)),
