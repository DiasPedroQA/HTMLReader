...
class ElpiLexer(RegexLexer):
    ...
    tokens = {
        ...
        "elpi": [
            ...
            (rf"\b(external pred|pred)(\s+)({const_sym_re})", bygroups(Keyword.Declaration, Text.Whitespace, Name.Function), "elpi-pred-item"),
            (rf"\b(external type|type)(\s+)(({const_sym_re}(,\s*)?)+)", bygroups(Keyword.Declaration, Text.Whitespace, Name.Function), "elpi-type"),
            (rf"\b(kind)(\s+)(({const_sym_re}|,)+)", bygroups(Keyword.Declaration, Text.Whitespace, Name.Function), "elpi-type"),
            (rf"\b(typeabbrev)(\s+)({const_sym_re})", bygroups(Keyword.Declaration, Text.Whitespace, Name.Function), "elpi-type"),
            (r"\b(typeabbrev)(\s+)(\([^)]+\))", bygroups(Keyword.Declaration, Text.Whitespace, Name.Function), "elpi-type"),
            (r"\b(accumulate)(\s+)(\")", bygroups(Keyword.Declaration, Text.Whitespace, String.Double), "elpi-string"),
            (rf"\b(accumulate|namespace|local)(\s+)({constant_re})", bygroups(Keyword.Declaration, Text.Whitespace, Text)),
            ...
            (rf"\b(constraint)(\s+)(({const_sym_re}(\s+)?)+)", bygroups(Keyword.Declaration, Text.Whitespace, Name.Function), "elpi-chr-rule-start"),
