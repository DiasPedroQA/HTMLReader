...
class BasicMagics(Magics):
    ...
    def _magic_docs(self, brief=False, rest=False):
        ...
        return "".join(
            [format_string % (magic_escapes["line"], fname, indent(dedent(fndoc))) for fname, fndoc in sorted(docs["line"].items())]
            + [format_string % (magic_escapes["cell"], fname, indent(dedent(fndoc))) for fname, fndoc in sorted(docs["cell"].items())]
        )
...
Currently the magic system has the following functions:""",
    ...
    def colors(self, parameter_s=""):
        ...
        if not new_theme:
            ...
            raise UsageError("%colors: you must specify a color theme. See '%colors?'." f" Available themes: {list(theme_table.keys())}")
