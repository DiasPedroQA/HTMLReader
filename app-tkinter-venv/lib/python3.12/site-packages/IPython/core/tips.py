...
_tips: Any = {
    ...
    "every_year": {
        ...
        (
            10,
            11,
        ): "IPython's first line of code was written {} years ago by Fernando Pérez".format(datetime.now().year - 2001),
        (
            12,
            9,
...
if os.name == "nt":
    ...
    _tips["every_year"] = {k: v for k, v in _tips["every_year"].items() if all(ord(char) < 128 for char in v)}
else:
    _tips["random"].extend(
        [
