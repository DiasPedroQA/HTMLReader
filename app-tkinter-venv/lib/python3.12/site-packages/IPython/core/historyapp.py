...
class HistoryTrim(BaseIPythonApplication):
    ...
    def start(self):
        ...
        inputs = list(
            con.execute("SELECT session, line, source, source_raw FROM " "history ORDER BY session DESC, line DESC LIMIT ?", (self.keep + 1,))
        )
...
class HistoryApp(Application):
    ...
    def start(self):
        if self.subapp is None:
            print("No subcommand specified. Must specify one of: " + ", ".join(map(repr, self.subcommands)) + ".\n")
