...
class ProgressBar(DisplayObject):
    ...
    def _repr_html_(self):
        return "<progress style='width:{}' max='{}' value='{}'></progress>".format(self.html_width, self.total, self.progress)
...
def _webpxy(data):
    ...
    if data[12:16] == b"VP8 ":
        ...
        height = 1 + ((((size_info >> 8) & 0xF) << 10) | (((size_info >> 14) & 0x3FC) << 2) | ((size_info >> 22) & 0x3))
        return (width, height)
    else:
