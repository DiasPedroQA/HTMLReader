...
class FrameInfo:
    ...
    @classmethod
    def _from_stack_data_FrameInfo(cls, frame_info: stack_data.core.FrameInfo | stack_data.core.RepeatedFrames) -> "FrameInfo":
        return cls(
        ...
        *,
        ...
        if sd is None:
            try:
                ...
                self.raw_lines = ["'Could not get source, probably due dynamically evaluated source code.'"]
