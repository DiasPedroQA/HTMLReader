...
class DeduperReloaderPatchingMixin:
    ...
    def infer_field_offset(
        ...
        for offset in range(1, _MAX_FIELD_SEARCH_OFFSET):
            if ctypes.cast(obj_addr + WORD_N_BYTES * offset, ctypes.POINTER(WORD_TYPE)).contents.value == field_addr:
                ret = offset
                break
        return ret
    ...
    def try_write_readonly_attr(
        ...
        ctypes.cast(obj_addr + WORD_N_BYTES * offset, ctypes.POINTER(WORD_TYPE)).contents.value = new_value_addr
