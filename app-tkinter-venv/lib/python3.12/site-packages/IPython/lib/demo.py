...
class Demo:
    ...
    def __init__(self, src, title="", arg_str="", auto_all=None, format_rst=False, formatter="terminal", style="default"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--formatter", "-f", default="terminal", help="pygments formatter name could be: terminal, " "terminal256, terminal16m")
