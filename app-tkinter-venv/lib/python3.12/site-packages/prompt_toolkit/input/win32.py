...
class ConsoleInputReader:
    ...
    def _event_to_key_presses(self, ev: KEY_EVENT_RECORD) -> list[KeyPress]:
        ...
        if (control_key_state & self.LEFT_CTRL_PRESSED or control_key_state & self.RIGHT_CTRL_PRESSED) and result and result.data == " ":
            result = KeyPress(Keys.ControlSpace, " ")

        # Turn Control-Enter into META-Enter. (On a vt100 terminal, we cannot
        # detect this combination. But it's really practical on Windows.)
        if (control_key_state & self.LEFT_CTRL_PRESSED or control_key_state & self.RIGHT_CTRL_PRESSED) and result and result.key == Keys.ControlJ:
