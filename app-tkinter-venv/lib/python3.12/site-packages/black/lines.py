...
class Line:
    ...
    def is_def(self) -> bool:
        ...
        return (first_leaf.type == token.NAME and first_leaf.value == "def") or (
            first_leaf.type == token.ASYNC and second_leaf is not None and second_leaf.type == token.NAME and second_leaf.value == "def"
        )
...
class EmptyLineTracker:
    ...
    def _maybe_empty_lines_for_class_or_def(self, current_line: Line, before: int, user_had_newline: bool) -> tuple[int, int]:  # noqa: C901
        assert self.previous_line is not None
...
def is_line_short_enough(line: Line, *, mode: Mode, line_str: str = "") -> bool:  # noqa: C901
    ...
    if Preview.multiline_string_handling not in mode:
        return str_width(line_str) <= mode.line_length and "\n" not in line_str and not line.contains_standalone_comments()  # multiline strings
