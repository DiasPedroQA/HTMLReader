...
def put_trailing_semicolon_back(src: str, has_trailing_semicolon: bool) -> str:
    ...
    for idx, token in reversed_enumerate(tokens):
        ...
        raise AssertionError(
            "INTERNAL ERROR: Was not able to reinstate trailing semicolon. " "Please report a bug on https://github.com/psf/black/issues.  "
        ) from None
    ...
    def visit_Assign(self, node: ast.Assign) -> None:
        ...
        if isinstance(node.value, ast.Call) and _is_ipython_magic(node.value.func):
            ...
            if node.value.func.attr == "getoutput":
                ...
                raise AssertionError(
                    f"Unexpected IPython magic {node.value.func.attr!r} found. " "Please report a bug on https://github.com/psf/black/issues."
                ) from None
