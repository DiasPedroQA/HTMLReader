...
class Opts:
    ...
    concurrency = optparse.make_option(
        ...
        action="store",
        metavar="LIBS",
        help=("Properly measure code using a concurrency library. " + "Valid values are: {}, or a comma-list of them.").format(
            ", ".join(sorted(CoverageConfig.CONCURRENCY_CHOICES))
        ),
    )
    ...
    contexts = optparse.make_option(
        ...
        help=("Only display data from lines covered in the given contexts. " + "Accepts Python regexes, which must be quoted."),
    )
    ...
    datafle_input = optparse.make_option(
        ...
        action="store",
        metavar="INFILE",
        help=("Read coverage data for report generation from this file. " + "Defaults to '.coverage'. [env: COVERAGE_FILE]"),
    )
    ...
    include = optparse.make_option(
        ...
        action="store",
        metavar="PAT1,PAT2,...",
        help=("Include only files whose paths match one of these patterns. " + "Accepts shell-style wildcards, which must be quoted."),
    )
    ...
    module = optparse.make_option(
        ...
        "--module",
        action="store_true",
        help=("<pyfile> is an importable Python module, not a script path, " + "to be run as 'python -m' would run it."),
    )
    omit = optparse.make_option(
        ...
        action="store",
        metavar="PAT1,PAT2,...",
        help=("Omit files whose paths match one of these patterns. " + "Accepts shell-style wildcards, which must be quoted."),
    )
    ...
    sort = optparse.make_option(
        ...
        action="store",
        metavar="COLUMN",
        help=("Sort the report by the named column: name, stmts, miss, branch, brpart, or cover. " + "Default is name."),
    )
...
HELP_TOPICS = {
    ...
    """,
    "minimum_help": ("Code coverage for Python, version {__version__} {extension_modifier}.  " + "Use '{program_name} help' for help."),
