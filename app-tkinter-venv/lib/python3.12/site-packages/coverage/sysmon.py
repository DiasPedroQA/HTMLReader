...
if LOG:  # pragma: debugging
    ...
    def arg_repr(arg: Any) -> str:
        ...
        if isinstance(arg, CodeType):
            return f"<code @{id(arg):#x}" + f" name={arg.co_name}," + f" file={short_filename(arg.co_filename)!r}#{arg.co_firstlineno}>"
        return repr(arg)
...
class SysMonitor(Tracer):
    ...
    @panopticon("code", "@", "@")
    def sysmon_branch_either(self, code: CodeType, instruction_offset: TOffset, destination_offset: TOffset) -> MonitorReturn:
